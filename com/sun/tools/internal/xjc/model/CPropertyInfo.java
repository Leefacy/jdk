...
/*     */   {
/* 261 */     Collection ts = ref();
/* 262 */     if (ts.size() != 1)
/*     */     {
/* 265 */       return false;
/*     */     }
/* 267 */     if ((this.baseType != null) && ((this.baseType instanceof JClass))) {
/* 268 */       return false;
/*     */     }
/* 270 */     CTypeInfo t = (CTypeInfo)ts.iterator().next();
/*     */ 
/* 272 */     return ((NType)t.getType()).isBoxedType();
/*     */   }
/*     */ 
 ...
 * Qualified Name:     com.sun.tools.internal.xjc.model.CPropertyInfo
