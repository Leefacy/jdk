...
/*    */       {
/* 58 */         localObject3 = new String[] { Util.getMessage("EvaluationException.lessThan"), left().value().getClass().getName(), right().value().getClass().getName() };
...
/*    */     {
/* 74 */       Object localObject2 = { Util.getMessage("EvaluationException.lessThan"), left().value().getClass().getName(), right().value().getClass().getName() };
 ...
 * Qualified Name:     com.sun.tools.corba.se.idl.constExpr.LessThan
