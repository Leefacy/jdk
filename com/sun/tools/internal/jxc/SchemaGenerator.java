...
/* 129 */     Method compileMethod = schemagenRunner.getDeclaredMethod("compile", new Class[] { [Ljava.lang.String.class, File.class });
/*     */ 
/* 131 */     Object aptargs = new ArrayList();
/*     */ 
/* 133 */     if (options.encoding != null) {
/* 134 */       ((List)aptargs).add("-encoding");
/* 135 */       ((List)aptargs).add(options.encoding);
/*     */     }
/*     */ 
/* 138 */     ((List)aptargs).add("-cp");
/* 139 */     ((List)aptargs).add(setClasspath(options.classpath));
/*     */ 
/* 141 */     if (options.targetDir != null) {
/* 142 */       ((List)aptargs).add("-d");
/* 143 */       ((List)aptargs).add(options.targetDir.getPath());
/*     */     }
/*     */ 
/* 146 */     ((List)aptargs).addAll(options.arguments);
/*     */ 
/* 148 */     String[] argsarray = (String[])((List)aptargs).toArray(new String[((List)aptargs).size()]);
...
/* 270 */       List recognizedOptions = new ArrayList();
/* 271 */       List unrecognizedOptions = new ArrayList();
/* 272 */       List classNames = new ArrayList();
/* 273 */       List files = new ArrayList();
...
/* 225 */       DiagnosticCollector diagnostics = new DiagnosticCollector();
/* 226 */       StandardJavaFileManager fileManager = compiler.getStandardFileManager(diagnostics, null, null);
/* 227 */       SchemaGenerator.JavacOptions options = SchemaGenerator.JavacOptions.parse(compiler, fileManager, args);
/* 228 */       List unrecognizedOptions = options.getUnrecognizedOptions();
...
/* 231 */       Iterable compilationUnits = fileManager.getJavaFileObjectsFromFiles(options.getFiles());
...
/*     */ 
/* 245 */       for (Diagnostic d : diagnostics.getDiagnostics()) {
 ...
 * Qualified Name:     com.sun.tools.internal.jxc.SchemaGenerator
