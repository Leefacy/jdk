...
/*     */         }
/*     */       }
/* 409 */       else if (existingOptions.contains(o)) {
...
/* 429 */       this.classLoader = new URLClassLoader(
/* 430 */         pathToURLs(this.classpath), 
/* 431 */         getClass().getClassLoader());
/*     */     }
...
/*     */     try
/*     */     {
/* 485 */       return new URL("file", "", name); } catch (MalformedURLException e) {
/*     */     }
...
/*     */     {
/* 141 */       switch (Options.1.$SwitchMap$com$sun$tools$internal$ws$wscompile$Options$Target[ordinal()]) {
/*     */       case 1:
/* 143 */         return "2.0";
/*     */       case 2:
/* 145 */         return "2.1";
 ...
 * Qualified Name:     com.sun.tools.internal.ws.wscompile.Options
