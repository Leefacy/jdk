...
/*  87 */       if (method.equals((JavaMethod)this.methods.get(i))) {
/*  88 */         return true;
/*     */       }
/*     */     }
/*  91 */     return false;
...
/* 114 */       if (interfaceName.equals((String)this.interfaces.get(i))) {
/* 115 */         return true;
/*     */       }
/*     */     }
/* 118 */     return false;
 ...
 * Qualified Name:     com.sun.tools.internal.ws.processor.model.java.JavaInterface
