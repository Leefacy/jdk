...
/*     */     {
/*  43 */       return (this.value == ((DoubleValue)paramObject).value()) && 
/*  43 */         (super
...
/*     */ 
/*     */   public Type type() {
/*  68 */     return this.vm.theDoubleType();
/*     */   }
/*     */ 
/*     */   public double value() {
...
/*     */   {
/* 132 */     if ((this.value > 2147483647.0D) || (this.value < -2147483648.0D)) {
 ...
 * Qualified Name:     com.sun.tools.jdi.DoubleValueImpl
