...
/* 181 */       return false;
/* 182 */     VirtualMachineDescriptor localVirtualMachineDescriptor = (VirtualMachineDescriptor)paramObject;
/* 183 */     if (localVirtualMachineDescriptor.provider() != provider()) {
/* 184 */       return false;
/*     */     }
/* 186 */     if (!localVirtualMachineDescriptor.id().equals(id())) {
/* 187 */       return false;
/*     */     }
/* 189 */     return true;
/*     */   }
