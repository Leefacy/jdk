...
/*     */ 
/*  92 */   private static final NoTypeVisitor NO_TYPE_VISITOR = new NoTypeVisitor(null);
/*     */ 
...
/*     */   {
/* 103 */     WebService webService = (WebService)e.getAnnotation(WebService.class);
...
/*     */ 
/* 110 */     switch (1.$SwitchMap$javax$lang$model$element$ElementKind[e.getKind().ordinal()]) {
/*     */     case 1:
...
/* 121 */       break;
/*     */     case 2:
/* 124 */       this.typeElementSoapBinding = ((SOAPBinding)e.getAnnotation(SOAPBinding.class));
...
/* 217 */     this.portName = ((webService != null) && (webService.name() != null) && (webService.name().length() > 0) ? webService
/* 218 */       .name() : this.portName);
/* 219 */     this.serviceName = (ClassNameInfo.getName(element.getQualifiedName().toString()) + WebServiceConstants.SERVICE.getValue());
/* 220 */     this.serviceName = ((webService != null) && (webService.serviceName() != null) && (webService.serviceName().length() > 0) ? webService
/* 221 */       .serviceName() : this.serviceName);
/* 222 */     this.wsdlNamespace = this.seiContext.getNamespaceUri();
/* 223 */     this.typeNamespace = this.wsdlNamespace;
/*     */ 
/* 225 */     SOAPBinding soapBinding = (SOAPBinding)element.getAnnotation(SOAPBinding.class);
...
/*     */   {
/* 237 */     return ((style.equals(SOAPBinding.Style.DOCUMENT)) && 
/* 235 */       (soapStyle
/* 235 */       .equals(SOAPStyle.DOCUMENT))) || (
/* 236 */       (style
/* 236 */       .equals(SOAPBinding.Style.RPC)) && 
/* 237 */       (soapStyle
...
/* 281 */       soapBinding = (SOAPBinding)this.soapBindingStack.peek();
...
/* 300 */     switch (1.$SwitchMap$javax$lang$model$element$ElementKind[element.getKind().ordinal()]) {
/*     */     case 1:
...
/*     */       }
/*     */ 
/* 307 */       SOAPBinding soapBinding = (SOAPBinding)element.getAnnotation(SOAPBinding.class);
/* 308 */       if ((soapBinding != null) && 
/* 309 */         (soapBinding
/* 309 */         .style() == SOAPBinding.Style.RPC) && 
/* 310 */         (soapBinding
...
/* 321 */       SOAPBinding soapBinding = (SOAPBinding)element.getAnnotation(SOAPBinding.class);
/* 322 */       if ((soapBinding != null) && 
/* 323 */         (soapBinding
/* 323 */         .style() == SOAPBinding.Style.RPC) && 
/* 324 */         (soapBinding
...
/* 349 */       WebMethod webMethod = (WebMethod)method.getAnnotation(WebMethod.class);
...
/* 357 */               .getQualifiedName(), method.toString()), method);
/*     */         }
/*     */         else {
/* 359 */           return true;
/*     */         }
...
/* 367 */     switch (1.$SwitchMap$javax$lang$model$element$ElementKind[element.getKind().ordinal()]) {
/*     */     case 1:
...
/* 391 */         processMethods((TypeElement)((DeclaredType)superclass).asElement()); break;
/*     */     }
/*     */   }
/*     */ 
...
/* 431 */       return null;
/* 432 */     WebMethod webMethod = (WebMethod)method.getAnnotation(WebMethod.class);
/* 433 */     if ((webMethod != null) && (webMethod.exclude()))
/* 434 */       return null;
/* 435 */     SOAPBinding soapBinding = (SOAPBinding)method.getAnnotation(SOAPBinding.class);
...
/* 438 */       soapBinding = (SOAPBinding)method.getEnclosingElement().getAnnotation(SOAPBinding.class);
...
/*     */ 
/* 479 */     Collection modifiers = method.getModifiers();
...
/*     */     }
/*     */ 
/* 490 */     boolean result = (this.endpointReferencesInterface) || 
/* 489 */       (method
/* 489 */       .getEnclosingElement().equals(this.typeElement)) || 
/* 490 */       (method
/* 490 */       .getEnclosingElement().getAnnotation(WebService.class) != null);
/* 491 */     this.builder.log("endpointReferencesInterface: " + this.endpointReferencesInterface);
/* 492 */     this.builder.log("declaring class has WebService: " + (method.getEnclosingElement().getAnnotation(WebService.class) != null));
...
/*     */ 
/* 502 */     Collection modifiers = classElement.getModifiers();
...
/* 559 */         return true;
/*     */     }
/* 561 */     List classMethods = getClassMethods(classElement);
/*     */ 
...
/* 584 */     List superclassesMethods = getClassMethods(superclassElement);
/* 585 */     List classMethods = ElementFilter.methodsIn(classElement.getEnclosedElements());
...
/* 598 */       (!typeUtils
/* 598 */       .isSubtype(method2
/* 598 */       .getReturnType(), method1.getReturnType())))
/* 599 */       return false;
/* 600 */     List parameters1 = method1.getParameters();
/* 601 */     List parameters2 = method2.getParameters();
...
/* 622 */     switch (1.$SwitchMap$javax$lang$model$element$ElementKind[element.getKind().ordinal()]) {
/*     */     case 1:
...
/*     */ 
/* 647 */       return (tE.getQualifiedName().toString().equals(Object.class.getName())) || 
...
/*     */   {
/* 656 */     WebMethod webMethod = (WebMethod)method.getAnnotation(WebMethod.class);
/*     */ 
...
/* 682 */       return false;
/*     */     }
/* 684 */     SOAPBinding soapBinding = (SOAPBinding)method.getAnnotation(SOAPBinding.class);
...
/* 734 */     WebParam webParam = (WebParam)param.getAnnotation(WebParam.class);
...
/* 779 */       inCnt = getModeParameterCount(method, WebParam.Mode.IN);
/* 780 */       if (inCnt != 1) {
...
/* 800 */       WebParam webParam = (WebParam)param.getAnnotation(WebParam.class);
...
/* 805 */             cnt++;
/*     */         }
/* 807 */       } else if (isEquivalentModes(mode, WebParam.Mode.IN)) {
/* 808 */         cnt++;
/*     */       }
/*     */     }
/*     */ 
...
/* 840 */       WebParam webParam = (WebParam)param.getAnnotation(WebParam.class);
 ...
 * Qualified Name:     com.sun.tools.internal.ws.processor.modeler.annotation.WebServiceVisitor
