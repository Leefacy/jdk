...
/*  77 */       this.$runtime.currentSchema.addAttGroupDecl(this.newAg, true);
/*     */     }
/*     */   }
/*     */ 
...
/*  87 */       this.$runtime.currentSchema.addModelGroupDecl(this.newGrp, true);
/*     */     }
/*     */   }
/*     */ 
...
/*  97 */       this.$runtime.currentSchema.addComplexType(this.newCt, true);
/*     */     }
/*     */   }
/*     */ 
...
/* 107 */       this.$runtime.currentSchema.addSimpleType(this.newSt, true);
/*     */     }
/*     */   }
/*     */ 
...
/* 356 */         this.$runtime.sendText(this._cookie, $value); } break;
/*     */     case 2:
 ...
 * Qualified Name:     com.sun.xml.internal.xsom.impl.parser.state.redefine
