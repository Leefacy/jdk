...
/* 112 */       return true;
/*     */     }
/* 114 */     List generatedImplFiles = ImplFile.toImplFiles(gImplFiles);
/*     */     try
/*     */     {
/* 117 */       implDestDir = makePackageDir(options);
/*     */ 
...
/*     */         {
/* 181 */           String simpleClassName = serviceName.getLocalPart() + "_" + portName
/* 181 */             .getLocalPart() + "Impl";
/* 182 */           String className = makePackageQualified(simpleClassName);
/* 183 */           this.implFiles.add(className);
/*     */ 
/* 185 */           if ((this.donotOverride) && (GeneratorUtil.classExists(this.options, className))) {
...
/*     */           }
/*     */ 
/* 243 */           for (com.sun.tools.internal.ws.processor.model.Operation operation : port.getOperations()) {
...
/* 251 */               JMethod m = cls.method(1, Void.TYPE, method.getName());
...
/* 266 */             for (JCommentPart ret = method.getParametersList().iterator(); ret.hasNext(); ) { parameter = (JavaParameter)ret.next();
/*     */ 
/* 268 */               JAXBTypeAndAnnotation paramType = parameter.getType().getType();
/*     */               JVar var;
/*     */               JVar var;
/* 269 */               if (parameter.isHolder())
/* 270 */                 var = m.param(holder.narrow(paramType.getType().boxify()), parameter
/* 271 */                   .getName());
/*     */               else {
...
/* 279 */             com.sun.tools.internal.ws.wsdl.document.Operation wsdlOp = operation
...
/* 314 */       (type
/* 314 */       .equals("long")) || 
/* 314 */       (type.equals("double")) || (type.equals("float"))) {
/* 315 */       return "return 0;";
/*     */     }
...
/*     */   {
/* 382 */     QName bName = (QName)port
/* 382 */       .getProperty("com.sun.xml.internal.ws.processor.model.WSDLBindingName");
/*     */ 
/* 383 */     if (bName == null) {
/* 384 */       return;
/*     */     }
 ...
 * Qualified Name:     com.sun.tools.internal.ws.processor.generator.JwsImplGenerator
