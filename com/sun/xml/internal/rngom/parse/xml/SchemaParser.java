...
/*      */ class SchemaParser
/*      */ {
/*   95 */   private static final String relaxngURIPrefix = "http://relaxng.org/ns/structure/1.0"
/*   95 */     .substring(0, "http://relaxng.org/ns/structure/1.0"
/*   95 */     .lastIndexOf('/') + 
/*   95 */     1);
...
/*      */   }
/*      */ 
/*      */   static abstract class AbstractContext extends DtdContext
/*      */     implements Context
/*      */   {
...
/*      */     AbstractContext()
/*      */     {
/*  133 */       this.prefixMapping = new SchemaParser.PrefixMapping("xml", "http://www.w3.org/XML/1998/namespace", null);
/*      */     }
/*      */ 
...
/*  142 */       for (SchemaParser.PrefixMapping p = this.prefixMapping; p != null; p = p.next) {
...
/*  152 */       for (SchemaParser.PrefixMapping p = this.prefixMapping; p != null; p = p.next) {
...
/*      */ 
/*      */     public Context copy() {
/*  161 */       return new SchemaParser.SavedContext(this);
/*      */     }
/*      */   }
/*      */ 
/*      */   class AnyNameState extends SchemaParser.NameClassBaseState
/*      */   {
...
/*      */     {
/* 1511 */       return new AnyNameState(SchemaParser.this);
/*      */     }
/*      */ 
...
/*      */         }
/* 1519 */         return new SchemaParser.NameClassChoiceState(SchemaParser.this, getContext());
/*      */       }
...
/*      */   }
/*      */ 
/*      */   class AttributeState extends SchemaParser.PatternContainerState
...
/*      */     SchemaParser.State create()
/*      */     {
/* 1014 */       return new AttributeState(SchemaParser.this);
/*      */     }
/*      */ 
...
/*      */       } else {
/* 1038 */         new SchemaParser.NameClassChildState(SchemaParser.this, this, this).set();
/*      */       }
/*      */     }
/*      */ 
...
/*      */     {
/* 1061 */       return SchemaParser.this.schemaBuilder.makeAttribute(this.nameClass, super.buildPattern(patterns, loc, null), loc, anno);
/*      */     }
/*      */ 
/*      */     SchemaParser.State createChildState(String localName) throws SAXException
/*      */     {
/* 1066 */       SchemaParser.State tem = super.createChildState(localName);
...
/*      */   }
/*      */ 
/*      */   class ChoiceState extends SchemaParser.PatternContainerState
/*      */   {
/*      */     ChoiceState()
/*      */     {
/*  662 */       super();
/*      */     }
/*      */     SchemaParser.State create() {
/*  665 */       return new ChoiceState(SchemaParser.this);
/*      */     }
/*      */ 
/*      */     ParsedPattern buildPattern(List<ParsedPattern> patterns, Location loc, Annotations anno) throws SAXException
/*      */     {
...
/*      */   }
/*      */ 
/*      */   class ContextImpl extends SchemaParser.AbstractContext
/*      */   {
/*      */     ContextImpl()
/*      */     {
/*      */     }
...
/*      */   }
/*      */ 
/*      */   class DataState extends SchemaParser.State
/*      */   {
/*      */     String type;
...
/*      */     SchemaParser.State create()
/*      */     {
/*  895 */       return new DataState(SchemaParser.this);
/*      */     }
/*      */ 
/*      */     SchemaParser.State createChildState(String localName) throws SAXException {
...
/*      */         }
/*  903 */         return new SchemaParser.ParamState(SchemaParser.this, this.dpb);
/*      */       }
/*  905 */       if (localName.equals("except")) {
/*  906 */         if (this.except != null) {
/*  907 */           SchemaParser.this.error("multiple_except");
/*      */         }
/*  909 */         return new SchemaParser.ChoiceState(SchemaParser.this);
/*      */       }
...
/*      */   }
/*      */ 
/*      */   class DefineState extends SchemaParser.DefinitionState
/*      */   {
/*      */     String name;
/*      */ 
...
/*      */ 
/*      */     SchemaParser.State create() {
/* 1369 */       return new DefineState(SchemaParser.this, null);
/*      */     }
/*      */ 
...
/*      */   }
/*      */ 
/*      */   abstract class DefinitionState extends SchemaParser.PatternContainerState
/*      */   {
...
/*      */   }
/*      */ 
/*      */   class DivState extends SchemaParser.GrammarSectionState
/*      */   {
/*      */     final Div div;
/*      */ 
/*      */     DivState(Div div)
...
/*      */   }
/*      */ 
/*      */   class ElementState extends SchemaParser.PatternContainerState
/*      */     implements SchemaParser.NameClassRef
/*      */   {
/*      */     ParsedNameClass nameClass;
/*      */     boolean nameClassWasAttribute;
...
/*      */       } else {
/*  724 */         new SchemaParser.NameClassChildState(SchemaParser.this, this, this).set();
/*      */       }
/*      */     }
/*      */ 
/*      */     SchemaParser.State create() {
/*  729 */       return new ElementState(SchemaParser.this);
/*      */     }
/*      */ 
/*      */     ParsedPattern buildPattern(List<ParsedPattern> patterns, Location loc, Annotations anno) throws SAXException
/*      */     {
/*  734 */       return SchemaParser.this.schemaBuilder.makeElement(this.nameClass, super.buildPattern(patterns, loc, null), loc, anno);
/*      */     }
/*      */ 
/*      */     void endForeignChild(ParsedElementAnnotation ea)
/*      */     {
...
/*      */   }
/*      */ 
/*      */   abstract class EmptyContentState extends SchemaParser.State
/*      */   {
/*      */     EmptyContentState()
/*      */     {
/*  529 */       super();
...
/*      */   }
/*      */ 
/*      */   class EmptyState extends SchemaParser.EmptyContentState
/*      */   {
/*      */     EmptyState()
/*      */     {
/*  813 */       super();
/*      */     }
/*      */     SchemaParser.State create() {
/*  816 */       return new EmptyState(SchemaParser.this);
/*      */     }
/*      */ 
...
/*      */   }
/*      */ 
/*      */   class ExternalRefState extends SchemaParser.EmptyContentState
/*      */   {
/*      */     String href;
/*      */ 
/*      */     ExternalRefState()
...
/*      */     SchemaParser.State create()
/*      */     {
/* 1291 */       return new ExternalRefState(SchemaParser.this);
/*      */     }
/*      */ 
/*      */     void setOtherAttribute(String name, String value) throws SAXException
/*      */     {
...
/*      */   }
/*      */ 
/*      */   class ForeignElementHandler extends SchemaParser.Handler
/*      */   {
...
/*      */       } else {
/*  469 */         this.builder = ((ElementAnnotationBuilder)this.builderStack.pop());
...
/*      */   }
/*      */ 
/*      */   class GrammarSectionState extends SchemaParser.State
/*      */   {
...
/*      */ 
/*      */     SchemaParser.State create() {
/* 1098 */       return new GrammarSectionState(SchemaParser.this, null);
/*      */     }
/*      */ 
/*      */     SchemaParser.State createChildState(String localName) throws SAXException {
/* 1102 */       if (localName.equals("define")) {
/* 1103 */         return new SchemaParser.DefineState(SchemaParser.this, this.section);
/*      */       }
/* 1105 */       if (localName.equals("start")) {
/* 1106 */         return new SchemaParser.StartState(SchemaParser.this, this.section);
/*      */       }
/* 1108 */       if (localName.equals("include")) {
/* 1109 */         Include include = this.section.makeInclude();
/* 1110 */         if (include != null) {
/* 1111 */           return new SchemaParser.IncludeState(SchemaParser.this, include);
/*      */         }
/*      */       }
/* 1114 */       if (localName.equals("div")) {
/* 1115 */         return new SchemaParser.DivState(SchemaParser.this, this.section.makeDiv());
/*      */       }
...
/*      */   }
/*      */ 
/*      */   class GrammarState extends SchemaParser.GrammarSectionState
/*      */   {
/*      */     Grammar grammar;
/*      */ 
/*      */     GrammarState()
...
/* 1216 */       this.section = this.grammar;
/* 1217 */       this.scope = this.grammar;
/*      */     }
/*      */ 
/*      */     SchemaParser.State create()
/*      */     {
/* 1222 */       return new GrammarState(SchemaParser.this);
/*      */     }
/*      */ 
/*      */     void end() throws SAXException
/*      */     {
...
/*      */   }
/*      */ 
/*      */   class GroupState extends SchemaParser.PatternContainerState
/*      */   {
/*      */     GroupState()
/*      */     {
/*  607 */       super();
/*      */     }
/*      */     SchemaParser.State create() {
/*  610 */       return new GroupState(SchemaParser.this);
/*      */     }
/*      */   }
/*      */ 
...
/*  224 */       SchemaParser.this.context.prefixMapping = new SchemaParser.PrefixMapping(prefix, uri, SchemaParser.this.context.prefixMapping);
/*      */     }
/*      */ 
...
/*      */   }
/*      */ 
/*      */   class IncludeState extends SchemaParser.GrammarSectionState
/*      */   {
/*      */     String href;
...
/*      */   }
/*      */ 
/*      */   class InterleaveState extends SchemaParser.PatternContainerState
/*      */   {
/*      */     InterleaveState()
/*      */     {
/*  674 */       super();
/*      */     }
/*      */     SchemaParser.State create() {
/*  677 */       return new InterleaveState(SchemaParser.this);
/*      */     }
/*      */ 
...
/*      */     LexicalHandlerImpl() {
/*      */     }
/* 1794 */     public void startDTD(String s, String s1, String s2) throws SAXException { this.inDtd = true; }
/*      */ 
/*      */     public void endDTD()
/*      */       throws SAXException
/*      */     {
...
/*      */     {
/* 1804 */       if (!this.inDtd)
/* 1805 */         ((SchemaParser.CommentHandler)SchemaParser.this.xr.getContentHandler()).comment(new String(chars, start, length));
/*      */     }
/*      */   }
/*      */ 
/*      */   class ListState extends SchemaParser.PatternContainerState
/*      */   {
/*      */     ListState()
/*      */     {
/*  650 */       super();
/*      */     }
/*      */     SchemaParser.State create() {
/*  653 */       return new ListState(SchemaParser.this);
/*      */     }
/*      */ 
/*      */     ParsedPattern buildPattern(List<ParsedPattern> patterns, Location loc, Annotations anno) throws SAXException
/*      */     {
/*  658 */       return SchemaParser.this.schemaBuilder.makeList(super.buildPattern(patterns, loc, null), loc, anno);
/*      */     }
/*      */   }
/*      */ 
/*      */   class MergeGrammarState extends SchemaParser.GrammarSectionState
/*      */   {
...
/*      */   }
/*      */ 
/*      */   class MixedState extends SchemaParser.PatternContainerState
/*      */   {
/*      */     MixedState()
/*      */     {
/*  686 */       super();
/*      */     }
/*      */     SchemaParser.State create() {
/*  689 */       return new MixedState(SchemaParser.this);
/*      */     }
/*      */ 
/*      */     ParsedPattern buildPattern(List<ParsedPattern> patterns, Location loc, Annotations anno) throws SAXException
/*      */     {
/*  694 */       return SchemaParser.this.schemaBuilder.makeMixed(super.buildPattern(patterns, loc, null), loc, anno);
/*      */     }
/*      */   }
/*      */ 
/*      */   abstract class NameClassBaseState extends SchemaParser.State
/*      */   {
/*      */     NameClassBaseState()
/*      */     {
/* 1464 */       super();
...
/*      */   }
/*      */ 
/*      */   class NameClassChildState extends SchemaParser.NameClassContainerState
/*      */   {
...
/*      */   }
/*      */ 
/*      */   class NameClassChoiceState extends SchemaParser.NameClassContainerState
/*      */   {
...
/*      */     SchemaParser.State create()
/*      */     {
/* 1597 */       return new NameClassChoiceState(SchemaParser.this);
/*      */     }
/*      */ 
/*      */     SchemaParser.State createChildState(String localName) throws SAXException
/*      */     {
...
/*      */   }
/*      */ 
/*      */   abstract class NameClassContainerState extends SchemaParser.State
/*      */   {
...
/*      */     }
/*      */     SchemaParser.State createChildState(String localName) throws SAXException {
/* 1420 */       SchemaParser.State state = (SchemaParser.State)SchemaParser.this.nameClassTable.get(localName);
/* 1421 */       if (state == null) {
...
/*      */   }
/*      */ 
/*      */   class NameState extends SchemaParser.NameClassBaseState
/*      */   {
...
/*      */ 
/*      */     SchemaParser.State create() {
/* 1483 */       return new NameState(SchemaParser.this);
/*      */     }
/*      */ 
...
/*      */   }
/*      */ 
/*      */   class NotAllowedState extends SchemaParser.EmptyContentState
/*      */   {
/*      */     NotAllowedState()
/*      */     {
/*  802 */       super();
/*      */     }
/*      */     SchemaParser.State create() {
/*  805 */       return new NotAllowedState(SchemaParser.this);
/*      */     }
/*      */ 
/*      */     ParsedPattern makePattern() {
...
/*      */   }
/*      */ 
/*      */   class NsNameState extends SchemaParser.AnyNameState
/*      */   {
/*      */     NsNameState()
/*      */     {
/* 1551 */       super();
...
/*      */ 
/*      */     SchemaParser.State create() {
/* 1555 */       return new NsNameState(SchemaParser.this);
/*      */     }
/*      */ 
/*      */     ParsedNameClass makeNameClassNoExcept()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   class OneOrMoreState extends SchemaParser.PatternContainerState
/*      */   {
/*      */     OneOrMoreState()
/*      */     {
/*  626 */       super();
/*      */     }
/*      */     SchemaParser.State create() {
/*  629 */       return new OneOrMoreState(SchemaParser.this);
/*      */     }
/*      */ 
/*      */     ParsedPattern buildPattern(List<ParsedPattern> patterns, Location loc, Annotations anno) throws SAXException
/*      */     {
/*  634 */       return SchemaParser.this.schemaBuilder.makeOneOrMore(super.buildPattern(patterns, loc, null), loc, anno);
/*      */     }
/*      */   }
/*      */   class OptionalState extends SchemaParser.PatternContainerState {
/*  638 */     OptionalState() { super(); }
/*      */ 
/*      */     SchemaParser.State create() {
/*  641 */       return new OptionalState(SchemaParser.this);
/*      */     }
/*      */ 
/*      */     ParsedPattern buildPattern(List<ParsedPattern> patterns, Location loc, Annotations anno) throws SAXException
/*      */     {
/*  646 */       return SchemaParser.this.schemaBuilder.makeOptional(super.buildPattern(patterns, loc, null), loc, anno);
/*      */     }
/*      */   }
/*      */ 
/*      */   class ParamState extends SchemaParser.State
/*      */   {
...
/*      */ 
/*      */     SchemaParser.State create() {
/*  965 */       return new ParamState(SchemaParser.this, null);
/*      */     }
/*      */ 
/*      */     void setName(String name) throws SAXException
/*      */     {
...
/*      */   }
/*      */ 
/*      */   class ParentRefState extends SchemaParser.RefState
/*      */   {
/*      */     ParentRefState()
/*      */     {
/* 1265 */       super();
...
/*      */ 
/*      */     SchemaParser.State create() {
/* 1269 */       return new ParentRefState(SchemaParser.this);
/*      */     }
/*      */ 
...
/*      */   }
/*      */ 
/*      */   abstract class PatternContainerState extends SchemaParser.State
/*      */   {
...
/*      */     SchemaParser.State createChildState(String localName) throws SAXException
/*      */     {
/*  556 */       SchemaParser.State state = (SchemaParser.State)SchemaParser.this.patternTable.get(localName);
/*  557 */       if (state == null) {
...
/*  566 */         return (ParsedPattern)patterns.get(0);
/*      */       }
...
/*  585 */         this.childPatterns.set(idx, SchemaParser.this.schemaBuilder.annotateAfter((ParsedPattern)this.childPatterns.get(idx), ea));
/*      */       }
/*      */     }
/*      */ 
/*      */     void end() throws SAXException {
...
/*  596 */         this.childPatterns.set(idx, SchemaParser.this.schemaBuilder.commentAfter((ParsedPattern)this.childPatterns.get(idx), this.comments));
...
/*      */   }
/*      */ 
/*      */   class RefState extends SchemaParser.EmptyContentState
/*      */   {
/*      */     String name;
/*      */ 
/*      */     RefState()
...
/*      */     SchemaParser.State create()
/*      */     {
/* 1237 */       return new RefState(SchemaParser.this);
/*      */     }
/*      */ 
/*      */     void endAttributes() throws SAXException
/*      */     {
...
/*      */   }
/*      */ 
/*      */   class RootState extends SchemaParser.PatternContainerState
/*      */   {
...
/*      */ 
/*      */     SchemaParser.State create() {
/*  762 */       return new RootState(SchemaParser.this);
/*      */     }
/*      */ 
/*      */     SchemaParser.State createChildState(String localName) throws SAXException
/*      */     {
...
/*  771 */         return new SchemaParser.MergeGrammarState(SchemaParser.this, this.grammar);
/*      */       }
...
/*      */   }
/*      */ 
/*      */   static class SavedContext extends SchemaParser.AbstractContext
/*      */   {
...
/*      */   }
/*      */ 
/*      */   abstract class SinglePatternContainerState extends SchemaParser.PatternContainerState
/*      */   {
...
/*      */   }
/*      */ 
/*      */   static class Skipper extends DefaultHandler
...
/*      */   }
/*      */ 
/*      */   class StartState extends SchemaParser.DefinitionState
/*      */   {
...
/*      */ 
/*      */     SchemaParser.State create() {
/* 1399 */       return new StartState(SchemaParser.this, null);
/*      */     }
/*      */ 
/*      */     void sendPatternToParent(ParsedPattern p)
/*      */     {
/* 1404 */       this.section.define("", this.combine, p, this.startLocation, this.annotations);
/*      */     }
/*      */ 
/*      */     SchemaParser.State createChildState(String localName) throws SAXException
/*      */     {
/* 1409 */       SchemaParser.State tem = super.createChildState(localName);
...
/*      */   }
/*      */ 
/*      */   abstract class State extends SchemaParser.Handler
/*      */   {
/*      */     State parent;
/*      */     String nsInherit;
/*      */     String ns;
...
/*      */ 
/*      */     abstract State createChildState(String paramString) throws SAXException;
/*      */ 
...
/*  267 */       } else if ((parent instanceof SchemaParser.RootState)) {
...
/*  287 */         if (state == null) {
/*  288 */           SchemaParser.this.xr.setContentHandler(new SchemaParser.Skipper(this));
/*  289 */           return;
/*      */         }
...
/*  296 */         SchemaParser.ForeignElementHandler feh = new SchemaParser.ForeignElementHandler(SchemaParser.this, this, getComments());
...
/*  350 */         } else if ((uri.equals("http://www.w3.org/XML/1998/namespace")) && 
/*  351 */           (atts
/*  351 */           .getLocalName(i)
/*  351 */           .equals("base"))) {
...
/*      */   }
/*      */ 
/*      */   class TextState extends SchemaParser.EmptyContentState
/*      */   {
/*      */     TextState()
/*      */     {
/*  824 */       super();
/*      */     }
/*      */     SchemaParser.State create() {
/*  827 */       return new TextState(SchemaParser.this);
/*      */     }
/*      */ 
/*      */     ParsedPattern makePattern() {
/*  831 */       return SchemaParser.this.schemaBuilder.makeText(this.startLocation, this.annotations); }  } 
/*  837 */   class ValueState extends SchemaParser.EmptyContentState { final StringBuffer buf = new StringBuffer();
/*      */     String type;
/*      */ 
/*  835 */     ValueState() { super(); }
/*      */ 
/*      */ 
/*      */     SchemaParser.State create()
/*      */     {
/*  841 */       return new ValueState(SchemaParser.this);
/*      */     }
/*      */ 
/*      */     void setOtherAttribute(String name, String value) throws SAXException
/*      */     {
...
/*      */   }
/*      */ 
/*      */   class ZeroOrMoreState extends SchemaParser.PatternContainerState
/*      */   {
/*      */     ZeroOrMoreState()
/*      */     {
/*  614 */       super();
/*      */     }
/*      */     SchemaParser.State create() {
/*  617 */       return new ZeroOrMoreState(SchemaParser.this);
/*      */     }
/*      */ 
/*      */     ParsedPattern buildPattern(List<ParsedPattern> patterns, Location loc, Annotations anno) throws SAXException
/*      */     {
/*  622 */       return SchemaParser.this.schemaBuilder.makeZeroOrMore(super.buildPattern(patterns, loc, null), loc, anno);
/*      */     }
/*      */   }
/*      */ }

/* Location:           D:\dt\jdk\tools.jar
 * Qualified Name:     com.sun.xml.internal.rngom.parse.xml.SchemaParser
