...
/*  96 */     return (Tokens.Token)this.savedTokens.get(paramInt - 1);
/*     */   }
/*     */ 
...
/* 113 */       this.token = ((Tokens.Token)this.savedTokens.remove(0));
/*     */     else
 ...
 * Qualified Name:     com.sun.tools.javac.parser.Scanner
