...
/*  51 */     String str = "";
/*  52 */     for (Flag localFlag : asFlagSet(paramLong)) {
/*  53 */       localStringBuilder.append(str);
/*  54 */       localStringBuilder.append(localFlag);
/*  55 */       str = " ";
/*     */     }
...
/*  61 */     EnumSet localEnumSet = EnumSet.noneOf(Flag.class);
/*  62 */     for (Flag localFlag : Flag.values()) {
/*  63 */       if ((paramLong & localFlag.value) != 0L) {
/*  64 */         localEnumSet.add(localFlag);
/*  65 */         paramLong &= (localFlag.value ^ 0xFFFFFFFF);
/*     */       }
/*     */     }
/*  68 */     Assert.check(paramLong == 0L, "Flags parameter contains unknown flags " + paramLong);
/*  69 */     return localEnumSet;
/*     */   }
/*     */ 
/*     */   public static Set<Modifier> asModifierSet(long paramLong)
/*     */   {
/* 308 */     Object localObject = (Set)modifierSets.get(Long.valueOf(paramLong));
/* 309 */     if (localObject == null) {
/* 310 */       localObject = EnumSet.noneOf(Modifier.class);
/* 311 */       if (0L != (paramLong & 1L)) ((Set)localObject).add(Modifier.PUBLIC);
/* 312 */       if (0L != (paramLong & 0x4)) ((Set)localObject).add(Modifier.PROTECTED);
/* 313 */       if (0L != (paramLong & 0x2)) ((Set)localObject).add(Modifier.PRIVATE);
/* 314 */       if (0L != (paramLong & 0x400)) ((Set)localObject).add(Modifier.ABSTRACT);
/* 315 */       if (0L != (paramLong & 0x8)) ((Set)localObject).add(Modifier.STATIC);
/* 316 */       if (0L != (paramLong & 0x10)) ((Set)localObject).add(Modifier.FINAL);
/* 317 */       if (0L != (paramLong & 0x80)) ((Set)localObject).add(Modifier.TRANSIENT);
/* 318 */       if (0L != (paramLong & 0x40)) ((Set)localObject).add(Modifier.VOLATILE);
/* 319 */       if (0L != (paramLong & 0x20))
/* 320 */         ((Set)localObject).add(Modifier.SYNCHRONIZED);
/* 321 */       if (0L != (paramLong & 0x100)) ((Set)localObject).add(Modifier.NATIVE);
/* 322 */       if (0L != (paramLong & 0x800)) ((Set)localObject).add(Modifier.STRICTFP);
/* 323 */       if (0L != (paramLong & 0x0)) ((Set)localObject).add(Modifier.DEFAULT);
/* 324 */       localObject = Collections.unmodifiableSet((Set)localObject);
/* 325 */       modifierSets.put(Long.valueOf(paramLong), localObject);
/*     */     }
...
/*     */   {
/* 335 */     return (paramSymbol.flags() & 0x8) != 0L;
/*     */   }
/*     */ 
/*     */   public static boolean isEnum(Symbol paramSymbol) {
/* 339 */     return (paramSymbol.flags() & 0x4000) != 0L;
/*     */   }
/*     */ 
...
/* 395 */     TYPE_TRANSLATED(1125899906842624L);
/*     */ 
/*     */     final long value;
/*     */     final String lowercaseName;
/*     */ 
/* 398 */     private Flag(long paramLong) { this.value = paramLong;
 ...
 * Qualified Name:     com.sun.tools.javac.code.Flags
