...
/*  56 */       UnaryExpression localUnaryExpression = (UnaryExpression)this.left;
/*  57 */       this.left = localUnaryExpression.right;
...
/*     */   {
/* 185 */     BinaryExpression localBinaryExpression = (BinaryExpression)clone();
/* 186 */     if (this.left != null) {
/* 187 */       localBinaryExpression.left = this.left.copyInline(paramContext);
/*     */     }
/* 189 */     if (this.right != null) {
/* 190 */       localBinaryExpression.right = this.right.copyInline(paramContext);
/*     */     }
/* 192 */     return localBinaryExpression;
/*     */   }
/*     */ 
/*     */   public int costInline(int paramInt, Environment paramEnvironment, Context paramContext)
/*     */   {
/* 200 */     return 1 + (this.left != null ? this.left.costInline(paramInt, paramEnvironment, paramContext) : 0) + (this.right != null ? this.right
/* 200 */       .costInline(paramInt, paramEnvironment, paramContext) : 
/* 200 */       0);
/*     */   }
/*     */ 
...
/* 211 */       Label localLabel1 = new Label();
/* 212 */       Label localLabel2 = new Label();
/*     */ 
/* 214 */       codeBranch(paramEnvironment, paramContext, paramAssembler, localLabel1, true);
/* 215 */       paramAssembler.add(true, this.where, 18, new Integer(0));
/* 216 */       paramAssembler.add(true, this.where, 167, localLabel2);
/* 217 */       paramAssembler.add(localLabel1);
/* 218 */       paramAssembler.add(true, this.where, 18, new Integer(1));
/* 219 */       paramAssembler.add(localLabel2);
/*     */     } else {
 ...
 * Qualified Name:     sun.tools.tree.BinaryExpression
