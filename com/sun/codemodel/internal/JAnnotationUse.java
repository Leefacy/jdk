...
/*     */       {
/* 411 */         f.g((JGenerable)this.memberValues.get("value"));
/*     */       }
/* 413 */       else for (Map.Entry mapEntry : this.memberValues.entrySet()) {
/* 414 */           if (!first) f.p(',');
/* 415 */           f.p((String)mapEntry.getKey()).p('=').g((JGenerable)mapEntry.getValue());
/* 416 */           first = false;
/*     */         }
/*     */ 
/* 419 */       f.p(')');
 ...
 * Qualified Name:     com.sun.codemodel.internal.JAnnotationUse
