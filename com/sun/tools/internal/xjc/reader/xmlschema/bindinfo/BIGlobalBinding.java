...
/* 203 */   boolean isJavaNamingConventionEnabled = true;
/*     */ 
/*     */   @XmlAttribute(name="mapSimpleTypeDef")
/* 209 */   boolean simpleTypeSubstitution = false;
/*     */ 
/*     */   @XmlTransient
/*     */   private BIProperty defaultProperty;
/*     */ 
/*     */   @XmlAttribute
/* 221 */   private boolean fixedAttributeAsConstantProperty = false;
/*     */ 
/*     */   @XmlAttribute
...
/*     */ 
/*     */   @XmlAttribute
/* 290 */   boolean generateElementClass = false;
/*     */ 
/*     */   @XmlAttribute
/* 293 */   boolean generateMixedExtensions = false;
/*     */ 
/*     */   @XmlElement(namespace="http://java.sun.com/xml/ns/jaxb/xjc")
/* 296 */   Boolean generateElementProperty = null;
/*     */ 
/*     */   @XmlAttribute
/* 304 */   boolean choiceContentProperty = false;
/*     */ 
/*     */   @XmlAttribute
...
/*     */       }
/* 173 */       else if (!SimpleTypeBuilder.canBeMappedToTypeSafeEnum(st))
...
/*     */     }
/* 402 */     this.defaultProperty = new BIProperty(getLocation(), null, null, null, this.collectionType, 
/* 403 */       Boolean.valueOf(this.fixedAttributeAsConstantProperty), 
/* 403 */       this.optionalProperty, this.generateElementProperty);
/* 404 */     this.defaultProperty.setParent(parent);
/*     */   }
/*     */ 
/*     */   public void dispatchGlobalConversions(XSSchemaSet schema)
/*     */   {
/* 412 */     for (Map.Entry e : this.globalConversions.entrySet())
/*     */     {
/* 414 */       QName name = (QName)e.getKey();
/* 415 */       BIConversion conv = (BIConversion)e.getValue();
/*     */ 
...
/*     */ 
/* 568 */     return (isEqual(this.nameConverter, b.nameConverter)) && 
...
/*     */   }
/*     */ 
/*     */   static final class ClassNameAdapter extends ReadOnlyAdapter<BIGlobalBinding.ClassNameBean, String>
/*     */   {
...
/*     */     {
/* 472 */       if (this.clazz != null) return this.clazz; try
/*     */       {
...
/*     */   {
/* 181 */     WORD_SEPARATOR(NameConverter.standard), 
/*     */ 
/* 183 */     CHAR_IN_WORD(NameConverter.jaxrpcCompatible);
/*     */ 
 ...
 * Qualified Name:     com.sun.tools.internal.xjc.reader.xmlschema.bindinfo.BIGlobalBinding
