...
/*     */   {
/*  55 */     String javaPortName = (String)port
/*  55 */       .getProperty("com.sun.xml.internal.ws.processor.model.JavaPortName");
/*     */ 
/*  56 */     if (javaPortName != null) {
/*  57 */       return javaPortName;
/*     */     }
/*     */ 
/*  60 */     QName portName = (QName)port
/*  60 */       .getProperty("com.sun.xml.internal.ws.processor.model.WSDLPortName");
/*     */ 
/*  62 */     if (portName != null) {
...
/*     */   {
/* 102 */     return RESERVED_WORDS.get(name) == null ? name : (String)RESERVED_WORDS.get(name);
/*     */   }
/*     */ 
 ...
 * Qualified Name:     com.sun.tools.internal.ws.processor.generator.Names
