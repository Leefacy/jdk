...
/* 105 */               startForking(uri, localName, qName, atts, new AnnotationParserFactoryImpl.ValidatorProtecter(AnnotationParserFactoryImpl.this.validator));
/*     */             }
/*     */ 
/* 109 */             for (int i = atts.getLength() - 1; i >= 0; i--)
/* 110 */               if ((atts.getURI(i).equals("http://www.w3.org/2005/05/xmlmime")) && 
/* 111 */                 (atts
/* 111 */                 .getLocalName(i)
/* 111 */                 .equals("expectedContentTypes")))
 ...
 * Qualified Name:     com.sun.tools.internal.xjc.reader.xmlschema.bindinfo.AnnotationParserFactoryImpl
