...
/*  97 */         Type localType = Type.tArray(this.right.type);
/*  98 */         paramUnaryExpression.right = new TypeExpression(this.where, localType);
/*  99 */         return paramVset;
/*     */       }
/*     */ 
...
/*     */   {
/* 182 */     ArrayAccessExpression localArrayAccessExpression = (ArrayAccessExpression)clone();
/* 183 */     localArrayAccessExpression.right = this.right.copyInline(paramContext);
/* 184 */     if (this.index == null)
/*     */     {
/* 188 */       localArrayAccessExpression.index = null;
/*     */     }
/* 190 */     else localArrayAccessExpression.index = this.index.copyInline(paramContext);
/*     */ 
/* 192 */     return localArrayAccessExpression;
/*     */   }
/*     */ 
/*     */   public int costInline(int paramInt, Environment paramEnvironment, Context paramContext)
/*     */   {
/* 204 */     return 1 + this.right.costInline(paramInt, paramEnvironment, paramContext) + this.index
...
/*     */   }
/*     */ 
/* 236 */   void codeStore(Environment paramEnvironment, Context paramContext, Assembler paramAssembler) { switch (this.type.getTypeCode()) {
/*     */     case 0:
/*     */     case 1:
 ...
 * Qualified Name:     sun.tools.tree.ArrayAccessExpression
