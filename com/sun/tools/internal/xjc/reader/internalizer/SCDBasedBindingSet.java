...
/* 211 */     return new Target(parent, src, scd, null);
/*     */   }
/*     */ 
...
/*     */   {
/* 242 */     SAXParseException e = new SAXParseException2(formattedMsg, this.forest.locatorTable
/* 242 */       .getStartLocation(errorSource), 
/* 242 */       nestedException);
/*     */ 
...
/*     */     {
/* 135 */       Collection childNodes = this.scd.select(contextNode);
...
/*     */       {
/* 152 */         Iterator itr = childNodes.iterator();
/* 153 */         target = (XSComponent)itr.next();
/* 154 */         if (itr.hasNext()) {
...
/*     */               try
/*     */               {
/* 169 */                 new DOMForestScanner(SCDBasedBindingSet.this.forest).scan(item, SCDBasedBindingSet.this.loader);
 ...
 * Qualified Name:     com.sun.tools.internal.xjc.reader.internalizer.SCDBasedBindingSet
