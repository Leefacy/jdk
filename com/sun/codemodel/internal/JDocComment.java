...
/*     */ 
/*     */ public class JDocComment extends JCommentPart
...
/*     */   {
/*  78 */     JCommentPart p = (JCommentPart)this.atParams.get(param);
/*  79 */     if (p == null)
...
/*     */   {
/* 103 */     JCommentPart p = (JCommentPart)this.atThrows.get(exception);
/* 104 */     if (p == null)
...
/*     */   {
/* 131 */     Map p = (Map)this.atXdoclets.get(name);
/* 132 */     if (p == null)
...
/*     */   {
/* 141 */     Map p = (Map)this.atXdoclets.get(name);
/* 142 */     if (p == null)
...
/*     */   {
/* 152 */     Map p = (Map)this.atXdoclets.get(name);
/* 153 */     if (p == null)
...
/*     */ 
/* 167 */     f.p(" * ").nl();
/* 168 */     for (Map.Entry e : this.atParams.entrySet()) {
/* 169 */       f.p(" * @param ").p((String)e.getKey()).nl();
...
/*     */     }
/* 176 */     for (Map.Entry e : this.atThrows.entrySet()) {
/* 177 */       f.p(" * @throws ").t((JClass)e.getKey()).nl();
...
/*     */     }
/* 184 */     for (Map.Entry e : this.atXdoclets.entrySet()) {
/* 185 */       f.p(" * @").p((String)e.getKey());
/* 186 */       if (e.getValue() != null) {
/* 187 */         for (Map.Entry a : ((Map)e.getValue()).entrySet()) {
/* 188 */           f.p(" ").p((String)a.getKey()).p("= \"").p((String)a.getValue()).p("\"");
/*     */         }
/*     */       }
/* 191 */       f.nl();
/*     */     }
 ...
 * Qualified Name:     com.sun.codemodel.internal.JDocComment
