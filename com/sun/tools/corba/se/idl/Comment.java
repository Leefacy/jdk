...
/*     */ 
/*  58 */   Comment() { this._text = new String(""); this._style = -1; } 
...
/*     */       }
/* 159 */       else paramPrintWriter.println(paramString + " * " + str2);
/* 160 */       i = j + _eol.length();
...
/*     */       }
/* 185 */       else paramPrintWriter.println(paramString + " * " + str2);
/* 186 */       i = j + _eol.length();
 ...
 * Qualified Name:     com.sun.tools.corba.se.idl.Comment
