...
/*     */   {
/* 145 */     this(eh, new CascadingDatatypeLibraryFactory(new DatatypeLibraryLoader(), new BuiltinDatatypeLibraryFactory(new DatatypeLibraryLoader())), new SchemaPatternBuilder());
/*     */   }
/*     */ 
...
/* 191 */       result = this.pb.makeChoice(result, (Pattern)patterns.get(i));
/*     */     }
/* 193 */     return result;
/*     */   }
/*     */ 
...
/* 203 */       result = this.pb.makeInterleave(result, (Pattern)patterns.get(i));
/*     */     }
/* 205 */     return result;
/*     */   }
/*     */ 
...
/* 215 */       result = this.pb.makeGroup(result, (Pattern)patterns.get(i));
/*     */     }
/* 217 */     return result;
/*     */   }
/*     */ 
...
/*     */       }
/*     */     }
/* 416 */     return new DummyDataPatternBuilder(null);
/*     */   }
/*     */ 
...
/*     */   {
/* 678 */     return new GrammarImpl(this, parent, null);
/*     */   }
/*     */ 
...
/*     */     throws BuildException
/*     */   {
/* 696 */     for (OpenIncludes inc = this.openIncludes; 
/* 697 */       inc != null; 
/* 698 */       inc = inc.parent)
...
/*     */     {
/*     */       try {
/* 332 */         this.dtb.addParameter(name, value, new SchemaBuilderImpl.ValidationContextImpl(context, ns));
/*     */       } catch (DatatypeException e) {
...
/* 471 */       Enumeration e = this.defines.keys();
...
/* 529 */           rp.setPattern(p);
/* 530 */         else if (rp.getCombineType() == 2)
/* 531 */           rp.setPattern(this.sb.pb.makeInterleave(rp.getPattern(), p));
/*     */         else {
...
/* 588 */       return new SchemaBuilderImpl.IncludeImpl(this.sb, this, null);
/*     */     }
/*     */   }
/*     */ 
...
/* 617 */       this.overrides = new SchemaBuilderImpl.Override(rp, this.overrides);
...
/*     */     {
/* 638 */       for (SchemaBuilderImpl.OpenIncludes inc = this.sb.openIncludes; 
/* 639 */         inc != null; 
/* 640 */         inc = inc.parent) {
...
/*     */       }
/*     */ 
/* 647 */       for (SchemaBuilderImpl.Override o = this.overrides; o != null; o = o.next) {
/* 648 */         o.replacementStatus = o.prp.getReplacementStatus();
/* 649 */         o.prp.setReplacementStatus((byte)1);
/*     */       }
/*     */       try {
/* 652 */         SchemaBuilderImpl isb = new SchemaBuilderImpl(ns, uri, this.sb, null);
/* 653 */         current.parseInclude(uri, isb, new SchemaBuilderImpl.GrammarImpl(isb, this.grammar), ns);
/* 654 */         for (SchemaBuilderImpl.Override o = this.overrides; o != null; o = o.next)
/* 655 */           if (o.prp.getReplacementStatus() == 1)
/* 656 */             if (o.prp.getName() == null)
/* 657 */               this.sb.error("missing_start_replacement", (Locator)loc);
/*     */             else
/* 659 */               this.sb.error("missing_define_replacement", o.prp.getName(), (Locator)loc);
/*     */       }
/*     */       catch (IllegalSchemaException e)
/*     */       {
...
/*     */       {
/*     */         SchemaBuilderImpl.Override o;
/* 666 */         for (SchemaBuilderImpl.Override o = this.overrides; o != null; o = o.next)
 ...
 * Qualified Name:     com.sun.xml.internal.rngom.binary.SchemaBuilderImpl
