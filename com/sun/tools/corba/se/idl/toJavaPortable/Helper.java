...
/*     */     {
/* 112 */       ValueBoxEntry localValueBoxEntry = (ValueBoxEntry)this.entry;
/* 113 */       TypedefEntry localTypedefEntry = ((InterfaceState)localValueBoxEntry.state().elementAt(0)).entry;
/* 114 */       SymtabEntry localSymtabEntry = localTypedefEntry.type();
/*     */ 
/* 116 */       if ((localSymtabEntry instanceof PrimitiveEntry))
/* 117 */         this.helperType = Util.javaName(this.entry);
/*     */       else
/* 119 */         this.helperType = Util.javaName(localSymtabEntry);
/*     */     }
/*     */     else {
...
/*     */   {
/* 139 */     Util.writePackage(this.stream, this.entry, (short)2);
/* 140 */     Util.writeProlog(this.stream, this.stream.name());
/*     */ 
/* 143 */     if (this.entry.comment() != null) {
/* 144 */       this.entry.comment().generate("", this.stream);
/*     */     }
...
/*     */ 
/* 228 */       Object localObject = (ValueEntry)this.entry;
/* 229 */       while (((ValueEntry)localObject).isSafe())
/*     */       {
/* 231 */         this.stream.println(",");
/* 232 */         ValueEntry localValueEntry = (ValueEntry)((ValueEntry)localObject).derivedFrom().elementAt(0);
/* 233 */         this.stream.print("    \"" + Util.stripLeadingUnderscoresFromID(localValueEntry.repositoryID().ID()) + "\"");
/* 234 */         localObject = localValueEntry;
/*     */       }
...
/*     */   {
/* 284 */     int i = ((this.entry instanceof ValueEntry)) || ((this.entry instanceof ValueBoxEntry)) || ((this.entry instanceof StructEntry)) ? 1 : 0;
/*     */ 
...
/* 304 */       ((JavaGenerator)this.entry.generator()).helperType(0, "          ", new TCOffsets(), "__typeCode", this.entry, this.stream);
/*     */     }
/*     */     else {
/* 307 */       ((JavaGenerator)this.entry.generator()).helperType(0, "      ", new TCOffsets(), "__typeCode", this.entry, this.stream);
/*     */     }
/*     */ 
/* 311 */     if (i != 0) {
...
/* 343 */       InterfaceEntry localInterfaceEntry = (InterfaceEntry)this.entry;
/*     */ 
/* 347 */       bool = localInterfaceEntry.isLocal() | localInterfaceEntry.isLocalServant();
/*     */     }
/*     */ 
...
/* 352 */     if (!bool)
/* 353 */       ((JavaGenerator)this.entry.generator()).helperRead(this.helperType, this.entry, this.stream);
/*     */     else {
...
/* 370 */       InterfaceEntry localInterfaceEntry = (InterfaceEntry)this.entry;
/*     */ 
/* 374 */       bool = localInterfaceEntry.isLocal() | localInterfaceEntry.isLocalServant();
/*     */     }
/*     */ 
...
/* 379 */     if (!bool)
/* 380 */       ((JavaGenerator)this.entry.generator()).helperWrite(this.entry, this.stream);
/*     */     else {
...
/*     */   {
/* 403 */     InterfaceEntry localInterfaceEntry = (InterfaceEntry)this.entry;
/*     */ 
/* 406 */     if (localInterfaceEntry.isLocal()) {
/* 407 */       writeRemoteNarrowForLocal(false);
/* 408 */       return;
/*     */     }
/*     */ 
/* 412 */     if (localInterfaceEntry.isAbstract()) {
/* 413 */       writeRemoteNarrowForAbstract(false);
/* 414 */       return;
/*     */     }
/*     */ 
/* 417 */     for (int i = 0; i < localInterfaceEntry.derivedFrom().size(); i++) {
/* 418 */       SymtabEntry localSymtabEntry = (SymtabEntry)localInterfaceEntry.derivedFrom().elementAt(i);
/* 419 */       if (((InterfaceEntry)localSymtabEntry).isAbstract()) {
...
/*     */   {
/* 519 */     InterfaceEntry localInterfaceEntry = (InterfaceEntry)this.entry;
/*     */ 
/* 522 */     if (localInterfaceEntry.isLocal()) {
/* 523 */       writeRemoteUncheckedNarrowForLocal(false);
/* 524 */       return;
/*     */     }
/*     */ 
/* 528 */     if (localInterfaceEntry.isAbstract()) {
/* 529 */       writeRemoteUncheckedNarrowForAbstract(false);
/* 530 */       return;
/*     */     }
/*     */ 
/* 533 */     for (int i = 0; i < localInterfaceEntry.derivedFrom().size(); i++) {
/* 534 */       SymtabEntry localSymtabEntry = (SymtabEntry)localInterfaceEntry.derivedFrom().elementAt(i);
/* 535 */       if (((InterfaceEntry)localSymtabEntry).isAbstract()) {
 ...
 * Qualified Name:     com.sun.tools.corba.se.idl.toJavaPortable.Helper
