...
/*     */   }
/*     */ 
/*     */   protected class DXMLPrinterVisitor extends DXMLPrinter.XMLWriter
...
/* 260 */       super();
/*     */     }
/* 262 */     protected void on(DPattern p) { p.accept(this); }
/*     */ 
...
/* 308 */           throw new DXMLPrinter.XMLWriterException(DXMLPrinter.this, e);
/*     */         }
/*     */     }
/*     */ 
...
/*     */     }
/*     */   }
/*     */   protected class NameClassXMLPrinterVisitor extends DXMLPrinter.XMLWriter implements NameClassVisitor<Void> {
/* 487 */     protected NameClassXMLPrinterVisitor() { super(); }
/*     */ 
...
/*     */       } catch (XMLStreamException e) {
/* 170 */         throw new DXMLPrinter.XMLWriterException(DXMLPrinter.this, e);
/*     */       }
/*     */     }
/*     */ 
...
/*     */       }
/*     */       catch (XMLStreamException e) {
/* 180 */         throw new DXMLPrinter.XMLWriterException(DXMLPrinter.this, e);
/*     */       }
/*     */     }
/*     */ 
...
/*     */       } catch (XMLStreamException e) {
/* 188 */         throw new DXMLPrinter.XMLWriterException(DXMLPrinter.this, e);
/*     */       }
/*     */     }
/*     */ 
...
/*     */       } catch (XMLStreamException e) {
/* 196 */         throw new DXMLPrinter.XMLWriterException(DXMLPrinter.this, e);
/*     */       }
/*     */     }
/*     */ 
...
/* 205 */         DXMLPrinter.this.indent += 1;
/* 206 */         DXMLPrinter.this.afterEnd = false;
/*     */       } catch (XMLStreamException e) {
/* 208 */         throw new DXMLPrinter.XMLWriterException(DXMLPrinter.this, e);
/*     */       }
/*     */     }
/*     */ 
/*     */     public void end() {
/*     */       try {
/* 214 */         DXMLPrinter.this.indent -= 1;
...
/*     */       } catch (XMLStreamException e) {
/* 222 */         throw new DXMLPrinter.XMLWriterException(DXMLPrinter.this, e);
/*     */       }
/*     */     }
/*     */ 
...
/*     */       } catch (XMLStreamException e) {
/* 230 */         throw new DXMLPrinter.XMLWriterException(DXMLPrinter.this, e);
/*     */       }
/*     */     }
/*     */ 
...
/*     */       } catch (XMLStreamException e) {
/* 238 */         throw new DXMLPrinter.XMLWriterException(DXMLPrinter.this, e);
/*     */       }
/*     */     }
/*     */ 
...
/*     */       } catch (XMLStreamException e) {
/* 246 */         throw new DXMLPrinter.XMLWriterException(DXMLPrinter.this, e);
/*     */       }
/*     */     }
/*     */ 
...
/*     */       } catch (XMLStreamException e) {
/* 255 */         throw new DXMLPrinter.XMLWriterException(DXMLPrinter.this, e);
/*     */       }
/*     */     }
/*     */   }
/*     */ 
 ...
 * Qualified Name:     com.sun.xml.internal.rngom.digested.DXMLPrinter
