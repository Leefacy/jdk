...
/*     */     {
/*  43 */       return (this.value == ((IntegerValue)paramObject).value()) && 
/*  43 */         (super
...
/*  58 */     return value() == i ? 0 : value() < i ? -1 : 1;
/*     */   }
/*     */ 
/*     */   public Type type() {
/*  62 */     return this.vm.theIntegerType();
/*     */   }
/*     */ 
/*     */   public int value() {
 ...
 * Qualified Name:     com.sun.tools.jdi.IntegerValueImpl
