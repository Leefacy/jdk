...
/* 203 */                 (AppletClassLoader.this.base
/* 203 */                 .getHost().equals(localURL.getHost())) && 
/* 204 */                 (AppletClassLoader.this.base
/* 204 */                 .getPort() == localURL.getPort())) {
...
/* 284 */         (str2
/* 284 */         .toLowerCase().endsWith(".jar")) || 
/* 285 */         (str2
/* 285 */         .toLowerCase().endsWith(".zip"))))
/*     */       {
...
/*     */       }
/*     */ 
/* 437 */       return localInputStream; } catch (Exception localException) {
/*     */     }
/* 439 */     return null;
/*     */   }
/*     */ 
...
/*     */       Object localObject;
/* 522 */       if ((localURLConnection instanceof HttpURLConnection)) {
...
/* 594 */         return (!this.done) && ((localEnumeration.hasMoreElements()) || (localURL2 != null));
/*     */       }
/*     */     };
/*     */   }
/*     */ 
