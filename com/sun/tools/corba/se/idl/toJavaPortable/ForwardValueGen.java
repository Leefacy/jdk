...
/*     */   implements com.sun.tools.corba.se.idl.ForwardValueGen, JavaGenerator
/*     */ {
...
/*     */   {
/*  92 */     this.stream = Util.stream(this.v, ".java");
/*     */   }
/*     */ 
/*     */   protected void generateHelper()
/*     */   {
/* 100 */     ((Factories)Compile.compiler.factories()).helper().generate(this.symbolTable, this.v);
/*     */   }
/*     */ 
/*     */   protected void generateHolder()
/*     */   {
/* 108 */     ((Factories)Compile.compiler.factories()).holder().generate(this.symbolTable, this.v);
/*     */   }
/*     */ 
...
/*     */   {
/* 123 */     Util.writePackage(this.stream, this.v);
 ...
 * Qualified Name:     com.sun.tools.corba.se.idl.toJavaPortable.ForwardValueGen
