...
/*     */     case '^':
/*     */     case '_':
/* 105 */     case '`': } throw new IOException();
/*     */   }
/*     */ 
/*     */   protected void setTabSize(int i)
/*     */   {
/* 131 */     this.tabSize = i; } 
/* 132 */   protected int getTabSize(int i) { return this.tabSize; }
/*     */ 
...
/* 317 */       AdjustBuffSize();
/*     */     char c;
/* 319 */     if ((this.buffer[this.bufpos] = c = ReadByte()) == '\\')
/*     */     {
...
/*     */         try
/*     */         {
/* 332 */           if ((this.buffer[this.bufpos] = c = ReadByte()) != '\\')
/*     */           {
...
/* 365 */           this.column += 1;
/*     */         char tmp295_294 = ((char)(hexval(c) << 12 | 
/* 368 */           hexval(ReadByte()) << 8 | 
/* 369 */           hexval(ReadByte()) << 4 | 
/* 370 */           hexval(ReadByte()))); c = tmp295_294;
/*     */ 
/* 367 */         this.buffer[this.bufpos] = 
/* 370 */           tmp295_294;
/*     */ 
/* 372 */         this.column += 4;
/*     */       }
...
/*     */     }
/* 484 */     this.prevCharIsLF = (this.prevCharIsCR = 0);
...
/*     */     }
/*     */ 
/* 631 */     int i = 0; int j = 0; int k = 0;
/* 632 */     int nextColDiff = 0; int columnDiff = 0;
/*     */ 
 ...
 * Qualified Name:     com.sun.xml.internal.rngom.parse.compact.JavaCharStream
