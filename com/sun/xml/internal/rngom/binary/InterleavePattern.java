...
/*  54 */       combineHashCode(17, p1
/*  54 */       .hashCode(), p2.hashCode()), p1, p2);
/*     */   }
/*     */ 
...
/*     */     }
/*  98 */     if ((context != 6) && 
/*  99 */       (!contentTypeGroupable(this.p1
/*  99 */       .getContentType(), this.p2.getContentType())))
/* 100 */       throw new RestrictionViolationException("interleave_string");
/* 101 */     if ((this.p1.getContentType() == 2) && 
/* 102 */       (this.p2
 ...
 * Qualified Name:     com.sun.xml.internal.rngom.binary.InterleavePattern
