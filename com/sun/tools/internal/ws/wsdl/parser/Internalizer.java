...
/*  78 */   private static final ContextClassloaderLocal<XPathFactory> xpf = new ContextClassloaderLocal()
/*     */   {
...
/* 115 */         String wsdlLocation = bindings.getAttribute("wsdlLocation");
/*     */         try
/*     */         {
/* 122 */           wsdlLocation = new URL(new URL(this.forest.getSystemId(bindings.getOwnerDocument())), wsdlLocation)
/* 122 */             .toExternalForm();
...
/*     */ 
/* 184 */         children = getChildElements(bindings);
...
/*     */     }
/*     */ 
/* 273 */     return (bindings.getNamespaceURI().equals("http://java.sun.com/xml/ns/jaxws")) && (
/* 269 */       (bindings
/* 269 */       .getLocalName().equals("package")) || 
/* 270 */       (bindings
/* 270 */       .getLocalName().equals("enableAsyncMapping")) || 
/* 271 */       (bindings
/* 271 */       .getLocalName().equals("enableAdditionalSOAPHeaderMapping")) || 
/* 272 */       (bindings
/* 272 */       .getLocalName().equals("enableWrapperStyle")) || 
/* 273 */       (bindings
/* 273 */       .getLocalName().equals("enableMIMEContent")));
/*     */   }
/*     */ 
/*     */   private static Element[] getChildElements(Element parent) {
/* 277 */     ArrayList a = new ArrayList();
...
/*     */       {
/* 284 */         if (("http://java.sun.com/xml/ns/jaxws".equals(item.getNamespaceURI())) || 
/* 285 */           ("http://java.sun.com/xml/ns/jaxb"
/* 285 */           .equals(item
/* 285 */           .getNamespaceURI())))
/* 286 */           a.add((Element)item);
/*     */       }
/*     */     }
/* 289 */     return (Element[])a.toArray(new Element[a.size()]);
/*     */   }
/*     */ 
...
/*     */   {
/* 516 */     SAXParseException e = new SAXParseException2(formattedMsg, this.forest.locatorTable
/* 516 */       .getStartLocation(errorSource), 
/* 516 */       nestedException);
/*     */ 
 ...
 * Qualified Name:     com.sun.tools.internal.ws.wsdl.parser.Internalizer
