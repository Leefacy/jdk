...
/* 62 */         if ((i != 0) || (j != 0))
/*    */         {
/* 64 */           localObject2 = new String[] { Util.getMessage("EvaluationException.plus"), left().value().getClass().getName(), right().value().getClass().getName() };
...
/* 71 */         value(((BigInteger)localObject2).add(localBigInteger));
/*    */       }
/*    */ 
/*    */     }
/*    */     catch (ClassCastException localClassCastException)
/*    */     {
/* 77 */       Object localObject1 = { Util.getMessage("EvaluationException.plus"), left().value().getClass().getName(), right().value().getClass().getName() };
 ...
 * Qualified Name:     com.sun.tools.corba.se.idl.constExpr.Plus
