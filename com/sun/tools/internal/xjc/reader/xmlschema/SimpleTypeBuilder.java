...
/* 288 */   public final XSSimpleTypeFunction<TypeUse> composer = new XSSimpleTypeFunction()
/*     */   {
...
/* 195 */     return (XSComponent)this.refererStack.peek();
/*     */   }
/*     */ 
...
/* 221 */       BIConversion conv = (BIConversion)info.get(BIConversion.class);
/* 222 */       if (conv != null) {
...
/*     */ 
/* 334 */     BindInfo info = this.builder.getBindInfo(type);
...
/*     */           }
/*     */ 
/* 371 */           return new CClassRef(this.model, type, en, info.toCustomizationList());
/*     */         }
/*     */ 
...
/* 407 */         TypeUse r = bindToTypeSafeEnum(rst, null, null, Collections.emptyMap(), 
...
/*     */ 
/* 431 */     List facets = type.getDeclaredFacets("enumeration");
...
/* 464 */       if ((t.isGlobal()) && (this.builder.getGlobalBinding().canBeMappedToTypeSafeEnum(t)))
/* 465 */         return true;
/*     */     }
/* 467 */     return false;
/*     */   }
...
/*     */     }
/*     */ 
/* 558 */     className = this.builder.deriveName(className, type);
/*     */ 
...
/* 588 */     List memberList = buildCEnumConstants(type, false, members, errorRef);
/* 589 */     if ((memberList == null) || (checkMemberNameCollision(memberList) != null)) {
/* 590 */       switch (2.$SwitchMap$com$sun$tools$internal$xjc$reader$xmlschema$bindinfo$EnumMemberMode[mode.ordinal()])
/*     */       {
/*     */       case 1:
/* 593 */         return null;
/*     */       case 2:
...
/*     */     }
/*     */ 
/* 628 */     CEnumLeafInfo xducer = new CEnumLeafInfo(this.model, BGMBuilder.getName(type), scope, className, baseDt, memberList, type, this.builder
/* 628 */       .getBindInfo(type)
/* 628 */       .toCustomizationList(), loc);
...
/*     */ 
/* 636 */     this.builder.getOrCreateBindInfo(type).addDecl(conv);
/*     */ 
...
/*     */   {
/* 649 */     List memberList = new ArrayList();
/* 650 */     int idx = 1;
/* 651 */     Set enums = new HashSet();
/*     */ 
/* 653 */     for (XSFacet facet : type.getDeclaredFacets("enumeration")) {
/* 654 */       String name = null;
/* 655 */       String mdoc = this.builder.getBindInfo(facet).getDocumentation();
/*     */ 
...
/* 666 */           BIEnumMember mem = (BIEnumMember)members.get(facetValue);
/* 667 */           if (mem == null)
/*     */           {
/* 669 */             mem = (BIEnumMember)this.builder.getBindInfo(facet).get(BIEnumMember.class);
/*     */           }
/* 671 */           if (mem != null) {
/* 672 */             name = mem.name;
/* 673 */             if (mdoc == null) {
...
/*     */         }
/*     */ 
/* 696 */         memberList.add(new CEnumConstant(name, mdoc, facet.getValue().value, facet, this.builder.getBindInfo(facet).toCustomizationList(), facet.getLocator()));
/*     */       }
/*     */     }
...
/*     */   {
/* 709 */     Map names = new HashMap();
/* 710 */     for (CEnumConstant c : memberList) {
/* 711 */       CEnumConstant old = (CEnumConstant)names.put(c.getName(), c);
/* 712 */       if (old != null)
/*     */       {
...
/*     */       }
/*     */     }
/* 771 */     return (TypeUse)builtinConversions.get(typeLocalName);
/*     */   }
/*     */ 
...
/*     */       try
/*     */       {
/* 786 */         List types = MimeTypeRange.parseRanges(emt);
...
/* 804 */           Messages.format("ERR_ILLEGAL_EXPECTED_MIME_TYPE", new Object[] { emt, e
/* 804 */           .getMessage() }), new Object[0]);
/*     */       }
/*     */       catch (MimeTypeParseException e) {
/* 807 */         getErrorReporter().error(referer.getLocator(), 
/* 808 */           Messages.format("ERR_ILLEGAL_EXPECTED_MIME_TYPE", new Object[] { emt, e
/* 808 */           .getMessage() }), new Object[0]);
/*     */       }
/*     */     }
/*     */ 
...
/*     */   static
/*     */   {
/* 143 */     builtinConversions = new HashMap();
/*     */ 
/* 474 */     Set s = new HashSet();
/*     */ 
...
/*     */ 
/* 869 */     LONG_MIN = BigInteger.valueOf(-9223372036854775808L);
/* 870 */     LONG_MAX = BigInteger.valueOf(9223372036854775807L);
/* 871 */     INT_MIN = BigInteger.valueOf(-2147483648L);
/* 872 */     INT_MAX = BigInteger.valueOf(2147483647L);
/*     */ 
/* 879 */     Map m = builtinConversions;
/*     */ 
 ...
 * Qualified Name:     com.sun.tools.internal.xjc.reader.xmlschema.SimpleTypeBuilder
