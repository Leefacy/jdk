...
/*  238 */             AppletViewer.this.validate(); } break;
/*      */         case 51236:
...
/*      */ 
/*  435 */     SocketPermission localSocketPermission1 = new SocketPermission(this.panel
/*  435 */       .getCodeBase().getHost(), "connect");
...
/*  443 */         (localAppletPanel
/*  443 */         .getDocumentBase().equals(this.panel.getDocumentBase())))
/*      */       {
/*  446 */         SocketPermission localSocketPermission2 = new SocketPermission(localAppletPanel
/*  446 */           .getCodeBase().getHost(), "connect");
/*      */ 
...
/*      */ 
/*  465 */     SocketPermission localSocketPermission1 = new SocketPermission(this.panel
/*  465 */       .getCodeBase().getHost(), "connect");
/*      */ 
...
/*      */       {
/*  472 */         SocketPermission localSocketPermission2 = new SocketPermission(localAppletPanel
/*  472 */           .getCodeBase().getHost(), "connect");
...
/*  576 */       int k = 0;
/*  577 */       while ((k < i) && 
/*  578 */         (arrayOfString[k].compareTo(str2) < 0)) {
/*  577 */         k++;
/*      */       }
/*      */ 
...
/*      */ 
/*  671 */         FileDialog localFileDialog = new FileDialog(AppletViewer.this, 
/*  671 */           AppletViewer.amh.getMessage("appletsave.filedialogtitle"), 1);
/*      */ 
...
/*      */           try { BufferedOutputStream localBufferedOutputStream = new BufferedOutputStream(localFileOutputStream);
/*      */ 
/*  686 */             Object localObject2 = null;
/*      */             try {
/*  688 */               ObjectOutputStream localObjectOutputStream = new ObjectOutputStream(localBufferedOutputStream);
/*      */ 
/*  686 */               Object localObject3 = null;
/*      */               try
/*      */               {
...
/*      */           finally
/*      */           {
/*  692 */             if (localFileOutputStream != null) if (localObject1 != null) try { localFileOutputStream.close(); } catch (Throwable localThrowable9) { localObject1.addSuppressed(localThrowable9); } else localFileOutputStream.close();  
/*      */           } } catch (IOException localIOException) { System.err.println(AppletViewer.amh.getMessage("appletsave.err2", localIOException));
/*      */         } finally {
...
/*      */       try
/*      */       {
/* 1286 */         Permission localPermission = paramURL
/* 1286 */           .openConnection().getPermission();
