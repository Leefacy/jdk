...
/*  91 */       List ms = new ArrayList(model.getMappings().size());
...
/*     */   {
/* 118 */     return (JAXBMapping)this.byQName.get(elementName);
/*     */   }
/*     */ 
/*     */   public JAXBMapping get(String className)
/*     */   {
/* 124 */     return (JAXBMapping)this.byClassName.get(className);
/*     */   }
/*     */ 
 ...
 * Qualified Name:     com.sun.tools.internal.ws.processor.model.jaxb.JAXBModel
