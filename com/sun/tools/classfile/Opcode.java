...
/*     */ 
/* 403 */   private Opcode(int paramInt) { this(Set.STANDARD, paramInt, Instruction.Kind.NO_OPERANDS); }
/*     */ 
/*     */   private Opcode(int paramInt, Instruction.Kind paramKind)
/*     */   {
/* 407 */     this(Set.STANDARD, paramInt, paramKind);
/*     */   }
/*     */ 
/*     */   private Opcode(Set paramSet, int paramInt) {
/* 411 */     this(paramSet, paramInt, paramSet == Set.STANDARD ? Instruction.Kind.NO_OPERANDS : Instruction.Kind.WIDE_NO_OPERANDS);
/*     */   }
/*     */ 
/*     */   private Opcode(Set paramSet, int paramInt, Instruction.Kind paramKind) {
/* 415 */     this.set = paramSet;
/* 416 */     this.opcode = paramInt;
...
/*     */ 
/* 456 */     for (Opcode localOpcode : values())
/* 457 */       getOpcodeBlock(localOpcode.opcode >> 8)[(localOpcode.opcode & 0xFF)] = localOpcode;
/*     */   }
/*     */ 
 ...
 * Qualified Name:     com.sun.tools.classfile.Opcode
