...
/*     */   {
/*  84 */     List paramList = new ArrayList();
...
/*     */     }
/*     */ 
/*  92 */     JavaStructureType jst = new JavaStructureType(jaxbType.getJavaType()
...
/*     */ 
/* 119 */     JavaStructureMember jsm = new JavaStructureMember(elementName
...
/* 123 */     type.add(eType);
/*     */ 
/* 125 */     JAXBType t = new JAXBType(elementName, javaType, jaxbType
...
/* 153 */         Parameter parameter = createParameter(part.getName(), param, block);
...
/* 216 */       JAXBElementMember member1 = (JAXBElementMember)members.next();
/* 217 */       JavaStructureMember javaMember1 = member1.getJavaStructureMember();
/*     */ 
/* 219 */       JavaStructureMember javaMember2 = ((JavaStructureType)struct2
/* 219 */         .getJavaType()).getMemberByName(member1
/* 220 */         .getJavaStructureMember().getName());
/* 221 */       if ((javaMember2.getConstructorPos() != i) || 
/* 222 */         (!javaMember1
/* 222 */         .getType().equals(javaMember2.getType()))) {
/* 223 */         return false;
/*     */       }
/*     */     }
/* 226 */     return false;
...
/* 235 */         List props = jt.getWrapperChildren();
 ...
 * Qualified Name:     com.sun.tools.internal.ws.processor.modeler.wsdl.ModelerUtils
