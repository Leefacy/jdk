...
/* 193 */     BatchEnvironment localBatchEnvironment = paramContextStack.getEnv();
/*     */ 
/* 197 */     boolean bool = true;
/*     */     try
/*     */     {
/* 200 */       ClassDeclaration localClassDeclaration = getClassDefinition().getSuperClass(localBatchEnvironment);
/* 201 */       if (localClassDeclaration != null) {
/* 202 */         ClassDefinition localClassDefinition = localClassDeclaration.getClassDefinition(localBatchEnvironment);
/* 203 */         this.parent = ((ClassType)makeType(localClassDefinition.getType(), localClassDefinition, paramContextStack));
/* 204 */         if (this.parent == null)
/* 205 */           bool = false;
/*     */       }
/*     */     }
/*     */     catch (ClassNotFound localClassNotFound) {
/* 209 */       classNotFound(paramContextStack, localClassNotFound);
 ...
 * Qualified Name:     sun.rmi.rmic.iiop.ClassType
