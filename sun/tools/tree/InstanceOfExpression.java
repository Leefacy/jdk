...
/*  69 */       paramEnvironment.error(this.where, "class.not.found", localClassNotFound.name, opNames[this.op]);
/*     */     }
/*  71 */     return paramVset;
/*     */   }
/*     */ 
...
/*     */     }
/*     */ 
/*  90 */     ClassDefinition localClassDefinition = paramContext.field.getClassDefinition();
/*     */     try
/*     */     {
/*  94 */       if ((this.right.type.isType(9)) || 
/*  95 */         (localClassDefinition
/*  95 */         .permitInlinedAccess(paramEnvironment, paramEnvironment
/*  95 */         .getClassDeclaration(this.right.type))))
/*     */       {
 ...
 * Qualified Name:     sun.tools.tree.InstanceOfExpression
