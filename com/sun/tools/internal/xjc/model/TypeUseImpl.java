...
/* 111 */     Class atype = this.adapter.getAdapterIfKnown();
/*     */ 
/* 114 */     if (((cons instanceof JStringLiteral)) && (atype != null)) {
/* 115 */       JStringLiteral scons = (JStringLiteral)cons;
/* 116 */       XmlAdapter a = (XmlAdapter)ClassFactory.create(atype);
/*     */       try {
...
/*     */       }
/*     */     }
/* 127 */     return JExpr._new(this.adapter.getAdapterClass(outline)).invoke("unmarshal").arg(cons);
/*     */   }
/*     */ }

/* Location:           D:\dt\jdk\tools.jar
 * Qualified Name:     com.sun.tools.internal.xjc.model.TypeUseImpl
