...
/*  54 */       UnaryExpression localUnaryExpression = (UnaryExpression)this.right;
/*  55 */       this.right = localUnaryExpression.right;
/*  56 */       localUnaryExpression.right = order();
/*  57 */       return localUnaryExpression;
/*     */     }
/*  59 */     return this;
/*     */   }
/*     */ 
...
/*     */   {
/* 169 */     UnaryExpression localUnaryExpression = (UnaryExpression)clone();
/* 170 */     if (this.right != null) {
/* 171 */       localUnaryExpression.right = this.right.copyInline(paramContext);
/*     */     }
/* 173 */     return localUnaryExpression;
/*     */   }
/*     */ 
 ...
 * Qualified Name:     sun.tools.tree.UnaryExpression
