...
/*     */     }
/* 172 */     if (isInterface()) {
/* 173 */       Iterator itfs = derived._implements();
/* 174 */       while (itfs.hasNext()) {
/* 175 */         if (isAssignableFrom((JClass)itfs.next()))
/* 176 */           return true;
/*     */       }
/*     */     }
/* 179 */     return false;
 ...
 * Qualified Name:     com.sun.codemodel.internal.JClass
