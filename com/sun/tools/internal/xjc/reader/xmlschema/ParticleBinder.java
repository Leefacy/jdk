...
/*     */   {
/* 102 */     return (BIProperty)getLocalCustomization(p, BIProperty.class);
/*     */   }
/*     */ 
/*     */   protected final <T extends BIDeclaration> T getLocalCustomization(XSParticle p, Class<T> type)
/*     */   {
/* 107 */     BIDeclaration cust = this.builder.getBindInfo(p).get(type);
/* 108 */     if (cust != null) return cust;
/*     */ 
/* 111 */     cust = this.builder.getBindInfo(p.getTerm()).get(type);
...
/* 214 */         String operator;
/*     */         String operator;
/* 214 */         if (mg.getCompositor() == XSModelGroup.CHOICE) operator = "Or"; else {
/* 215 */           operator = "And";
/*     */         }
 ...
 * Qualified Name:     com.sun.tools.internal.xjc.reader.xmlschema.ParticleBinder
