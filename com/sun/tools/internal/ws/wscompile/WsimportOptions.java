...
/*     */ 
/* 149 */   public static final String defaultAuthfile = System.getProperty("user.home") + 
/* 148 */     System.getProperty("file.separator") + ".metro" + 
/* 149 */     System.getProperty("file.separator") + 
/* 149 */     "auth";
...
/* 177 */   public final List<Plugin> activePlugins = new ArrayList();
...
/*     */   }
/*     */ 
/*     */   public int parseArguments(String[] args, int i)
/*     */     throws BadCommandLineException
/*     */   {
...
/* 305 */           this.entityResolver = new ForkEntityResolver(er, this.entityResolver);
/*     */         }
/*     */       } catch (IOException e) {
...
/*     */ 
/* 336 */       com.sun.tools.internal.xjc.Options jaxbOptions = this.schemaCompiler.getOptions();
/*     */       try {
...
/* 349 */       authfile = requireArgument("-Xauthfile", args, ++i);
...
/* 440 */       return (Element)this.handlerConfigs.get(0);
/* 441 */     return null;
/*     */   }
/*     */ 
...
/* 449 */     return (InputSource[])this.wsdls.toArray(new InputSource[this.wsdls.size()]);
/*     */   }
/*     */ 
/*     */   public InputSource[] getSchemas() {
/* 453 */     return (InputSource[])this.schemas.toArray(new InputSource[this.schemas.size()]);
/*     */   }
/*     */ 
/*     */   public InputSource[] getWSDLBindings() {
/* 457 */     return (InputSource[])this.jaxwsCustomBindings.toArray(new InputSource[this.jaxwsCustomBindings.size()]);
/*     */   }
/*     */ 
/*     */   public InputSource[] getSchemaBindings() {
/* 461 */     return (InputSource[])this.jaxbCustomBindings.toArray(new InputSource[this.jaxbCustomBindings.size()]);
/*     */   }
/*     */ 
...
/* 483 */       return new InputSource(Util.escapeSpace(url)); } catch (MalformedURLException e) {
/*     */     }
...
/* 533 */     addFile(name, this.bindingFiles, null);
/*     */   }
/*     */ 
...
/* 578 */         this.jaxwsCustomBindings.add(new RereadInputSource(is));
...
/* 581 */         this.jaxbCustomBindings.add(new RereadInputSource(is));
/*     */       } else {
...
/*     */   {
/* 597 */     return (String)this.extensionOptions.get(argument);
/*     */   }
/*     */ 
...
/*     */   {
/* 636 */     ServiceFinder serviceFinder = ServiceFinder.find(clazz, classLoader);
/* 637 */     List r = new ArrayList();
/* 638 */     for (Iterator localIterator = serviceFinder.iterator(); localIterator.hasNext(); ) { Object t = localIterator.next();
/* 639 */       r.add(t);
/*     */     }
/* 641 */     return r.toArray((Object[])Array.newInstance(clazz, r.size()));
/*     */   }
/*     */ 
...
/* 724 */       if ((i != null) && (!(i instanceof WsimportOptions.RereadInputStream))) {
/* 725 */         i = new WsimportOptions.RereadInputStream(i);
...
/*     */     private WsimportOptions.ByteStream bs;
/*     */ 
/*     */     RereadInputStream(InputStream is)
/*     */     {
/* 655 */       this.is = is;
/* 656 */       this.bs = new WsimportOptions.ByteStream(null);
/*     */     }
/*     */ 
 ...
 * Qualified Name:     com.sun.tools.internal.ws.wscompile.WsimportOptions
