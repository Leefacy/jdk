...
/*     */   {
/* 230 */     return (JInvocation)insert(new JInvocation(expr, method));
/*     */   }
/*     */ 
/*     */   public JInvocation staticInvoke(JClass type, String method)
/*     */   {
/* 237 */     return (JInvocation)insert(new JInvocation(type, method));
/*     */   }
/*     */ 
/*     */   public JInvocation invoke(String method)
/*     */   {
/* 249 */     return (JInvocation)insert(new JInvocation((JExpression)null, method));
/*     */   }
/*     */ 
/*     */   public JInvocation invoke(JMethod method)
/*     */   {
/* 261 */     return (JInvocation)insert(new JInvocation((JExpression)null, method));
/*     */   }
/*     */ 
...
/*     */   {
/* 286 */     return (JConditional)insert(new JConditional(expr));
/*     */   }
/*     */ 
/*     */   public JForLoop _for()
/*     */   {
/* 295 */     return (JForLoop)insert(new JForLoop());
/*     */   }
/*     */ 
/*     */   public JWhileLoop _while(JExpression test)
/*     */   {
/* 304 */     return (JWhileLoop)insert(new JWhileLoop(test));
/*     */   }
/*     */ 
/*     */   public JSwitch _switch(JExpression test)
/*     */   {
/* 311 */     return (JSwitch)insert(new JSwitch(test));
/*     */   }
/*     */ 
/*     */   public JDoLoop _do(JExpression test)
/*     */   {
/* 320 */     return (JDoLoop)insert(new JDoLoop(test));
/*     */   }
/*     */ 
/*     */   public JTryBlock _try()
/*     */   {
/* 329 */     return (JTryBlock)insert(new JTryBlock());
/*     */   }
/*     */ 
/*     */   public void _return()
/*     */   {
...
/* 429 */     for (Iterator localIterator = this.content.iterator(); localIterator.hasNext(); ) { Object o = localIterator.next();
...
/*     */   {
/* 445 */     return (JForEach)insert(new JForEach(varType, name, collection));
/*     */   }
/*     */ 
/*     */   public void state(JFormatter f) {
/* 449 */     f.g(this);
 ...
 * Qualified Name:     com.sun.codemodel.internal.JBlock
