...
/* 107 */       Class r = rt;
/*     */ 
/* 109 */       return new TypedAnnotationWriter(r, method
...
/* 160 */     JAnnotationArrayMember m = (JAnnotationArrayMember)this.arrays.get(name);
/* 161 */     if (m == null) {
...
/*     */   {
/* 222 */     return (JAnnotationWriter)Proxy.newProxyInstance(
/* 223 */       SecureLoader.getClassClassLoader(this.writerType), 
/* 223 */       new Class[] { this.writerType }, this);
/*     */   }
/*     */ 
/*     */   static <W extends JAnnotationWriter<?>> W create(Class<W> w, JAnnotatable annotatable)
/*     */   {
/* 231 */     Class a = findAnnotationType(w);
/* 232 */     return new TypedAnnotationWriter(a, w, annotatable.annotate(a)).createProxy();
/*     */   }
/*     */ 
...
/* 240 */           return (Class)p.getActualTypeArguments()[0];
/*     */       }
/* 242 */       if ((t instanceof Class))
/*     */       {
/* 244 */         Class r = findAnnotationType((Class)t);
 ...
 * Qualified Name:     com.sun.codemodel.internal.TypedAnnotationWriter
