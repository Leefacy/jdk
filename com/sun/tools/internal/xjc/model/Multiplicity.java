...
/* 166 */       .min(rhs.min), 
/* 166 */       (lhs.max == null) || (rhs.max == null) ? null : lhs.max
/* 167 */       .max(rhs.max));
/*     */   }
/*     */ 
...
/* 171 */       .add(rhs.min), 
/* 171 */       (lhs.max == null) || (rhs.max == null) ? null : lhs.max
/* 172 */       .add(rhs.max));
/*     */   }
/*     */ 
...
/* 204 */     return create(this.min, null);
/*     */   }
/*     */ }

/* Location:           D:\dt\jdk\tools.jar
 * Qualified Name:     com.sun.tools.internal.xjc.model.Multiplicity
