...
/* 177 */       d.onSetOwner(); 
/*     */   }
/* 179 */   public XSComponent getOwner() { return this.owner; }
/*     */ 
/*     */ 
...
/* 202 */         return (BIDeclaration)kind.cast(decl);
/*     */     }
/* 204 */     return null;
/*     */   }
/*     */ 
...
/*     */   {
/* 211 */     return (BIDeclaration[])this.decls.toArray(new BIDeclaration[this.decls.size()]);
/*     */   }
/*     */ 
...
/* 224 */     for (Iterator localIterator = this.documentation.contents.iterator(); localIterator.hasNext(); ) { Object c = localIterator.next();
...
/*     */   }
/* 278 */   public BIDeclaration get(int idx) { return (BIDeclaration)this.decls.get(idx); }
/*     */ 
...
/*     */     {
/* 128 */       if (this.contents == null) return;
/*     */ 
/* 130 */       for (Iterator localIterator = this.contents.iterator(); localIterator.hasNext(); ) { Object o = localIterator.next();
 ...
 * Qualified Name:     com.sun.tools.internal.xjc.reader.xmlschema.bindinfo.BindInfo
