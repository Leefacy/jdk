...
/* 342 */     char quoteChar = '\000';
/* 343 */     boolean sawQuestion = false;
/*     */ 
/* 346 */     for (int i = 0; (i < 507) && 
/* 347 */       ((c = r.read()) != -1); i++)
/*     */     {
...
/*     */ 
/*     */         }
/* 390 */         else if (!Character.isWhitespace((char)c))
/*     */         {
/* 392 */           if ((c == 34) || (c == 39)) {
/* 393 */             if (quoteChar == 0) {
...
/* 407 */                     if (i == 0)
/*     */                       break label513;
/* 409 */                     if ((i <= 0) || ((c != 45) && ((c < 48) || (c > 57)) && (c != 46) && (c != 95)))
/*     */                     {
/*     */                       break label513;
/*     */                     }
/*     */                   }
...
/*     */       }
/*     */     }
/* 429 */     label513: setEncoding(pb, "UTF-8");
/*     */   }
/*     */ 
...
/*     */   }
/*     */ 
/*     */   static final class AsciiReader extends XmlReader.BaseReader
/*     */   {
...
/*     */       throws IOException
/*     */     {
/* 538 */       return (this.instream == null) || (this.finish - this.start > 0) || 
/* 538 */         (this.instream
/* 538 */         .available() != 0);
/*     */     }
/*     */ 
...
/*     */   }
/*     */ 
/*     */   static final class Iso8859_1Reader extends XmlReader.BaseReader
/*     */   {
...
/*     */   }
/*     */ 
/*     */   static final class Utf8Reader extends XmlReader.BaseReader
/*     */   {
...
/*     */       }
/*     */ 
/* 573 */       if (this.nextChar != 0) {
/* 574 */         buf[(offset + i++)] = this.nextChar;
/* 575 */         this.nextChar = '\000';
/*     */       }
/*     */ 
/* 578 */       while (i < len)
/*     */       {
...
/* 648 */                   " can't be converted to Unicode.");
/*     */               }
/*     */ 
/* 652 */               c -= 65536;
...
/*     */             else
/*     */             {
/* 661 */               throw new CharConversionException("Unconvertible UTF-8 character beginning with 0x" + 
...
/*     */           else
/*     */           {
/* 692 */             for (this.start += 1; this.start < off; this.start += 1) {
...
/* 704 */             if ((this.nextChar != 0) && (i < len)) {
/* 705 */               buf[(offset + i++)] = this.nextChar;
/* 706 */               this.nextChar = '\000';
/*     */             }
/*     */           }
/*     */         }
/*     */       }
 ...
 * Qualified Name:     com.sun.xml.internal.dtdparser.XmlReader
