...
/*     */   {
/*  65 */     List newArgs = new ArrayList(this.args);
...
/*     */   public JClass narrow(JClass[] clazz)
/*     */   {
/*  72 */     List newArgs = new ArrayList(this.args);
...
/*     */   {
/* 128 */     f.t(this.basis).p('<').g(this.args).p(65535);
/*     */   }
/*     */ 
 ...
 * Qualified Name:     com.sun.codemodel.internal.JNarrowedClass
