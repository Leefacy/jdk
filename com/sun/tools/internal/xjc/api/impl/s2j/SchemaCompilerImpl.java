...
/*     */ 
/*     */ public final class SchemaCompilerImpl extends ErrorReceiver
...
/* 113 */     return this.forest.getParserHandler(systemId, true);
/*     */   }
/*     */ 
...
/* 200 */     this.forest = new DOMForest(new XMLSchemaInternalizationLogic(), this.opts);
...
/*     */   }
/*     */ 
/* 296 */   public void warning(SAXParseException exception) { if (this.errorListener != null)
...
/*     */   }
/*     */ 
/* 305 */   public void fatalError(SAXParseException exception) { this.hadError = true;
 ...
 * Qualified Name:     com.sun.tools.internal.xjc.api.impl.s2j.SchemaCompilerImpl
