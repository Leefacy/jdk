...
/*  59 */         return create((Type)Utils.REFLECTION_NAVIGATOR.getBaseClass(ent.t, enc.c));
/*     */       }
/*     */ 
/*  62 */       return null;
/*     */     }
...
/* 179 */       return create((Type)Utils.REFLECTION_NAVIGATOR.getTypeArgument(ent.t, i));
/*     */     }
/* 181 */     if ((nt instanceof NClassByJClass)) {
/* 182 */       NClassByJClass nnt = (NClassByJClass)nt;
/* 183 */       return ref((JClass)nnt.clazz.getTypeParameters().get(i));
/*     */     }
/*     */ 
 ...
 * Qualified Name:     com.sun.tools.internal.xjc.model.nav.NavigatorImpl
