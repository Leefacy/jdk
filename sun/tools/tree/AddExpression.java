...
/*  91 */       StringBuffer localStringBuffer = inlineValueSB(paramEnvironment, paramContext, new StringBuffer());
/*  92 */       if (localStringBuffer != null)
/*     */       {
/*  94 */         return new StringExpression(this.where, localStringBuffer.toString());
/*     */       }
/*     */ 
/*     */     }
/*     */ 
...
/*     */   {
/* 191 */     return (this.type.isType(10) ? 12 : 1) + this.left
/* 190 */       .costInline(paramInt, paramEnvironment, paramContext) + 
/* 190 */       this.right
...
/*     */         }
/*     */ 
/* 234 */         ClassDeclaration localClassDeclaration = paramEnvironment
/* 234 */           .getClassDeclaration(idJavaLangStringBuffer);
/*     */ 
/* 235 */         ClassDefinition localClassDefinition = paramContext.field.getClassDefinition();
/*     */ 
/* 237 */         codeAppend(paramEnvironment, paramContext, paramAssembler, localClassDeclaration, true);
/*     */ 
/* 240 */         MemberDefinition localMemberDefinition = localClassDeclaration
/* 240 */           .getClassDefinition(paramEnvironment)
/* 240 */           .matchMethod(paramEnvironment, localClassDefinition, idToString);
/*     */ 
/* 243 */         paramAssembler.add(this.where, 182, localMemberDefinition);
/*     */       } catch (ClassNotFound localClassNotFound) {
/* 245 */         throw new CompilerError(localClassNotFound);
/*     */       } catch (AmbiguousMember localAmbiguousMember) {
/* 247 */         throw new CompilerError(localAmbiguousMember);
/*     */       }
/*     */     else
 ...
 * Qualified Name:     sun.tools.tree.AddExpression
