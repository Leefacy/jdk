...
/* 135 */       CElement elementBean = ((ClassSelector)Ring.get(ClassSelector.class)).bindToType(decl, null);
...
/* 209 */       return new CTypeRef(this.target, this.decl);
/*     */     }
/*     */ 
...
/*     */       }
/* 262 */       BIXSubstitutable subst = (BIXSubstitutable)RawTypeSetBuilder.this.builder.getBindInfo(this.decl).get(BIXSubstitutable.class);
/* 263 */       if (subst != null) {
...
/* 311 */       TypeUse r = ((ClassSelector)Ring.get(ClassSelector.class)).bindToType(decl.getType(), decl);
...
/*     */ 
/* 333 */       CCustomizations custs = ((BGMBuilder)Ring.get(BGMBuilder.class)).getBindInfo(this.decl).toCustomizationList();
/*     */ 
/* 335 */       if (((this.target instanceof CClassInfo)) && (((BIGlobalBinding)Ring.get(BIGlobalBinding.class)).isSimpleMode()))
/*     */       {
/* 338 */         CClassInfo bean = new CClassInfo(model, scope, model
/* 337 */           .getNameConverter().toClassName(this.decl.getName()), this.decl
/* 338 */           .getLocator(), null, BGMBuilder.getName(this.decl), this.decl, custs);
/*     */ 
/* 340 */         bean.setBaseClass((CClassInfo)this.target);
/* 341 */         prop.getElements().add(bean);
/*     */       }
/*     */       else {
/* 344 */         CElementInfo e = new CElementInfo(model, BGMBuilder.getName(this.decl), scope, this.target, this.decl
/* 344 */           .getDefaultValue(), this.decl, custs, this.decl.getLocator());
 ...
 * Qualified Name:     com.sun.tools.internal.xjc.reader.xmlschema.RawTypeSetBuilder
