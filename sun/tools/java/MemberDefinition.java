...
/*  96 */       .getName().getFlatName().getName(), null, null);
/*     */ 
...
/*     */ 
/* 134 */     MemberDefinition localMemberDefinition = (MemberDefinition)proxyCache.get(str);
/*     */ 
/* 136 */     if (localMemberDefinition != null) {
/* 137 */       return localMemberDefinition;
/*     */     }
/*     */ 
/* 141 */     localMemberDefinition = new MemberDefinition(paramMemberDefinition.getWhere(), paramClassDefinition, paramMemberDefinition
/* 140 */       .getModifiers(), paramMemberDefinition.getType(), paramMemberDefinition
/* 141 */       .getName(), paramMemberDefinition.getExceptionIds(), null);
/*     */ 
/* 143 */     localMemberDefinition.exp = paramMemberDefinition.getExceptions(paramEnvironment);
/* 144 */     proxyCache.put(str, localMemberDefinition);
/*     */ 
/* 146 */     return localMemberDefinition;
/*     */   }
/*     */ 
...
/* 282 */       for (MemberDefinition localMemberDefinition = this.accessPeer; localMemberDefinition != null; localMemberDefinition = localMemberDefinition.accessPeer)
/*     */       {
/* 284 */         if (!localMemberDefinition.isAccessMethod()) {
/* 285 */           return localMemberDefinition;
/*     */         }
/*     */       }
/*     */     }
/* 289 */     return null;
...
/* 313 */       for (MemberDefinition localMemberDefinition = this.accessPeer; localMemberDefinition != null; localMemberDefinition = localMemberDefinition.accessPeer) {
/* 314 */         if (localMemberDefinition.isAccessMethod()) {
/* 315 */           return localMemberDefinition;
/*     */         }
/*     */       }
/*     */     }
/* 319 */     return null;
...
/*     */     }
/*     */ 
/* 527 */     Type localType1 = getType().getReturnType();
/* 528 */     Type localType2 = paramMemberDefinition.getType().getReturnType();
/*     */ 
/* 530 */     return localType1 == localType2;
/*     */   }
/*     */ 
/*     */   public boolean checkOverride(Environment paramEnvironment, MemberDefinition paramMemberDefinition)
/*     */   {
/* 548 */     return checkOverride(paramEnvironment, paramMemberDefinition, null);
/*     */   }
/*     */ 
...
/* 571 */     if (isSynthetic())
/*     */     {
/* 579 */       if ((!paramMemberDefinition.isFinal()) && 
/* 580 */         (!paramMemberDefinition
/* 580 */         .isConstructor()) && 
/* 581 */         (!paramMemberDefinition
...
/*     */     }
/*     */ 
/* 630 */     if ((paramMemberDefinition.reportDeprecated(paramEnvironment)) && (!isDeprecated()) && ((this instanceof SourceMember)))
/*     */     {
...
/* 657 */       (!exceptionsFit(paramEnvironment, paramMemberDefinition))) {
...
/*     */ 
/* 797 */     label128: for (int i = 0; i < arrayOfClassDeclaration1.length; i++) {
/*     */       try {
/* 799 */         ClassDefinition localClassDefinition = arrayOfClassDeclaration1[i].getClassDefinition(paramEnvironment);
/* 800 */         for (int j = 0; j < arrayOfClassDeclaration2.length; j++) {
/* 801 */           if (localClassDefinition.subClassOf(paramEnvironment, arrayOfClassDeclaration2[j])) {
/*     */             break label128;
/*     */           }
/*     */         }
/* 805 */         if (!localClassDefinition.subClassOf(paramEnvironment, paramEnvironment
/* 806 */           .getClassDeclaration(idJavaLangError)))
/*     */         {
/* 808 */           if (!localClassDefinition.subClassOf(paramEnvironment, paramEnvironment
...
/* 818 */         paramEnvironment.error(getWhere(), "class.not.found", localClassNotFound.name, paramMemberDefinition
...
/* 894 */     return ((isStatic()) || (isPrivate()) || (isFinal()) || (isConstructor()) || (paramBoolean)) && 
...
/*     */   {
/* 918 */     Identifier localIdentifier = getClassDefinition().getName();
...
/* 923 */       localStringBuffer.append(localIdentifier);
/* 924 */       localStringBuffer.append('(');
/* 925 */       Type[] arrayOfType = getType().getArgumentTypes();
/* 926 */       for (int i = 0; i < arrayOfType.length; i++) {
/* 927 */         if (i > 0) {
/* 928 */           localStringBuffer.append(',');
/*     */         }
/* 930 */         localStringBuffer.append(arrayOfType[i].toString());
/*     */       }
/* 932 */       localStringBuffer.append(')');
/* 933 */       return localStringBuffer.toString();
/* 934 */     }if (isInnerClass()) {
...
/* 982 */         this.value = Statement.empty;
/*     */       }
/* 985 */       else if ((i = ((Statement)this.value)
/* 985 */         .costInline(Statement.MAXINLINECOST, null, null)) >= 
/* 985 */         Statement.MAXINLINECOST)
/*     */       {
/* 988 */         this.value = Statement.empty;
/*     */       }
/*     */       else try {
/* 991 */           if (!isInlineable(null, true))
/* 992 */             this.value = Statement.empty;
/*     */         }
/*     */         catch (ClassNotFound localClassNotFound)
/*     */         {
/*     */         }
 ...
 * Qualified Name:     sun.tools.java.MemberDefinition
