...
/* 192 */     ThreadInfo localThreadInfo = ThreadInfo.getCurrentThreadInfo();
/* 193 */     if (localThreadInfo == null) {
/* 194 */       System.out
/* 195 */         .print(format("jdb prompt with no current thread"));
/*     */     }
/*     */     else {
/* 197 */       System.out
/* 198 */         .print(format("jdb prompt thread name and current stack frame", new Object[] { localThreadInfo
/* 200 */         .getThread().name(), new Integer(localThreadInfo
 ...
 * Qualified Name:     com.sun.tools.example.debug.tty.MessageOutput
