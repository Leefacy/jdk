...
/*      */   {
/*  336 */     return (this.fullTypeCode & 0x80000000) == -2147483648;
/*      */   }
/*      */ 
...
/*      */   {
/*  437 */     Vector localVector = new Vector();
/*      */ 
/*  441 */     addTypes(paramInt, paramHashSet, localVector);
/*      */ 
/*  445 */     Type[] arrayOfType = new Type[localVector.size()];
/*  446 */     localVector.copyInto(arrayOfType);
/*      */ 
...
/*      */   }
/*      */ 
/*      */   public void print(IndentingWriter paramIndentingWriter, int paramInt, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
/*      */     throws IOException
/*      */   {
...
/*      */   }
/*      */ 
/*      */   public static void print(IndentingWriter paramIndentingWriter, Type[] paramArrayOfType, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
/*      */     throws IOException
/*      */   {
/*  513 */     for (int i = 0; i < paramArrayOfType.length; i++)
/*  514 */       paramArrayOfType[i].println(paramIndentingWriter, paramBoolean1, paramBoolean2, paramBoolean3);
/*      */   }
/*      */ 
/*      */   public void print(IndentingWriter paramIndentingWriter, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
/*      */     throws IOException
/*      */   {
/*  530 */     printTypeName(paramIndentingWriter, paramBoolean1, paramBoolean2, paramBoolean3);
/*      */   }
/*      */ 
/*      */   public void println(IndentingWriter paramIndentingWriter, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
/*      */     throws IOException
/*      */   {
...
/*      */   }
/*      */ 
/*      */   public void printTypeName(IndentingWriter paramIndentingWriter, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
/*      */     throws IOException
/*      */   {
...
/*      */   }
/*      */ 
/*      */   protected void printPackageOpen(IndentingWriter paramIndentingWriter, boolean paramBoolean)
/*      */     throws IOException
/*      */   {
/*      */     Object localObject;
/*  585 */     if (paramBoolean) {
/*  586 */       localObject = getIDLModuleNames();
/*  587 */       for (int i = 0; i < localObject.length; i++)
/*  588 */         paramIndentingWriter.plnI("module " + localObject[i] + " {");
/*      */     }
/*      */     else {
/*  591 */       localObject = getPackageName();
/*  592 */       if (localObject != null)
/*  593 */         paramIndentingWriter.pln("package " + (String)localObject + ";");
/*      */     }
/*      */   }
/*      */ 
...
/*      */   {
/*  609 */     Type localType = (Type)paramContextStack.getEnv().allTypes.get(paramString);
/*      */ 
/*  611 */     if (localType != null) {
/*  612 */       paramContextStack.traceExistingType(localType);
/*      */     }
/*      */ 
/*  615 */     return localType;
/*      */   }
/*      */ 
/*      */   protected static void removeType(String paramString, ContextStack paramContextStack)
/*      */   {
/*  622 */     Type localType = (Type)paramContextStack.getEnv().allTypes.remove(paramString);
/*  623 */     paramContextStack.getEnv().invalidTypes.put(localType, paramString);
/*      */   }
/*      */ 
...
/*  631 */     Type localType = (Type)paramContextStack.getEnv().allTypes.remove(str);
/*  632 */     putInvalidType(localType, str, paramContextStack);
/*      */   }
/*      */ 
...
/*      */   {
/*  670 */     BatchEnvironment localBatchEnvironment = paramContextStack.getEnv();
/*  671 */     if (localBatchEnvironment.invalidTypes.size() > 0)
/*      */     {
/*  675 */       for (Enumeration localEnumeration = localBatchEnvironment.allTypes.elements(); localEnumeration.hasMoreElements(); ) {
/*  676 */         Type localType = (Type)localEnumeration.nextElement();
/*  677 */         localType.swapInvalidTypes();
/*      */       }
/*      */ 
/*  682 */       localBatchEnvironment.invalidTypes.clear();
/*      */     }
/*      */   }
/*      */ 
...
/*  735 */     Type localType = null;
/*  736 */     if (str != null) {
/*  737 */       localType = (Type)this.env.allTypes.get(str);
/*      */     }
/*      */ 
/*  740 */     if (localType == null) {
/*  741 */       throw new Error("Failed to find valid type to swap for " + paramType + " mis-identified as " + paramType.getTypeDescription());
/*      */     }
/*      */ 
/*  746 */     return localType;
/*      */   }
/*      */ 
/*      */   protected void printPackageClose(IndentingWriter paramIndentingWriter, boolean paramBoolean)
/*      */     throws IOException
/*      */   {
/*  756 */     if (paramBoolean) {
/*  757 */       String[] arrayOfString = getIDLModuleNames();
/*  758 */       for (int i = 0; i < arrayOfString.length; i++)
...
/*      */   {
/*  851 */     String str1 = "rmic.iiop.constraint." + paramInt;
/*      */ 
/*  853 */     if (!paramBoolean) {
/*  854 */       paramContextStack.getEnv().error(0L, str1, paramObject1 != null ? paramObject1
/*  855 */         .toString() : null, paramObject2 != null ? paramObject2
/*  856 */         .toString() : null, paramObject3 != null ? paramObject3
/*  857 */         .toString() : null);
/*      */     } else {
/*  859 */       String str2 = paramContextStack.getEnv().errorString(str1, paramObject1, paramObject2, paramObject3);
/*  860 */       paramContextStack.traceln(str2);
/*      */     }
/*      */ 
/*  863 */     return false;
/*      */   }
...
/*      */     try
/*      */     {
/*  922 */       return super.clone(); } catch (CloneNotSupportedException localCloneNotSupportedException) {
/*      */     }
 ...
 * Qualified Name:     sun.rmi.rmic.iiop.Type
