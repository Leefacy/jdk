...
/* 248 */         (paramString
/* 248 */         .length() != str1.length()) && 
/* 249 */         (!new File(paramString
/* 249 */         .substring(str1
/* 249 */         .length())).isAbsolute()))
/*     */       {
/* 255 */         String str2 = ParseUtil.fileToEncodedURL(new File(System.getProperty("user.dir"))).getPath() + paramString
/* 255 */           .substring(str1
/* 255 */           .length());
...
/*     */         try { localProperties.store(localFileOutputStream, lookup("main.prop.store")); }
/*     */         catch (Throwable localThrowable2)
/*     */         {
/* 435 */           localObject1 = localThrowable2; throw localThrowable2;
/*     */         } finally {
/* 437 */           if (localFileOutputStream != null) if (localObject1 != null) try { localFileOutputStream.close(); } catch (Throwable localThrowable3) { localObject1.addSuppressed(localThrowable3); } else localFileOutputStream.close();  
/*     */         } } catch (IOException localIOException) { System.err.println(lookup("main.err.prop.cantsave", localFile1
/* 439 */           .toString()));
/*     */       }
/*     */     }
...
/*     */     try
/*     */     {
/* 473 */       FileInputStream localFileInputStream = new FileInputStream(paramFile); localObject1 = null;
/*     */       try { localProperties2.load(new BufferedInputStream(localFileInputStream)); }
/*     */       catch (Throwable localThrowable2)
/*     */       {
...
/*     */       } } catch (IOException localIOException) { System.err.println(lookup("main.err.prop.cantread", paramFile.toString())); }
/*     */ 
/*     */ 
