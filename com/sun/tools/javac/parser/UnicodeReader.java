...
/*  71 */   protected char[] sbuf = new char[''];
/*     */   protected int sp;
...
/* 159 */       this.bp += 1; this.ch = this.buf[this.bp];
/* 160 */       if (this.ch == 'u') {
/*     */         do {
/* 162 */           this.bp += 1; this.ch = this.buf[this.bp];
/* 163 */         }while (this.ch == 'u');
/* 164 */         int i = this.bp + 3;
...
/* 169 */             this.bp += 1; this.ch = this.buf[this.bp];
...
/*     */           }
/*     */         }
/* 179 */         this.log.error(this.bp, "illegal.unicode.esc", new Object[0]);
/*     */       } else {
/* 181 */         this.bp -= 1;
/* 182 */         this.ch = '\\';
/*     */       }
...
/* 193 */       return true; } catch (NoSuchMethodError localNoSuchMethodError) {
/*     */     }
/* 195 */     return false;
/*     */   }
/*     */ 
 ...
 * Qualified Name:     com.sun.tools.javac.parser.UnicodeReader
