...
/*  71 */       paramEnvironment.error(this.where, "class.not.found", localClassNotFound.name, opNames[this.op]);
/*     */     }
/*     */ 
...
/*     */     }
/*     */ 
/* 106 */     ClassDefinition localClassDefinition = paramContext.field.getClassDefinition();
/*     */     try
/*     */     {
/* 110 */       if ((this.left.type.isType(9)) || 
/* 111 */         (localClassDefinition
 ...
 * Qualified Name:     sun.tools.tree.CastExpression
