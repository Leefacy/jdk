...
/*     */   private QName top()
/*     */   {
/* 149 */     return (QName)this.elementNames.peek();
/*     */   }
/*     */ 
...
/*     */       {
/* 162 */         QName schemaElement = (QName)this.elementNames.get(this.elementNames.size() - 3);
/* 163 */         if (prohibitedSchemaElementNames.contains(schemaElement.getLocalPart()))
/*     */         {
/* 165 */           this.errorHandler.error(new SAXParseException(
/* 166 */             Messages.format("CustomizationContextChecker.UnacknolwedgedCustomization", new Object[] { localName }), 
/* 166 */             this.locator));
/*     */         }
/*     */ 
/*     */       }
 ...
 * Qualified Name:     com.sun.tools.internal.xjc.reader.xmlschema.parser.CustomizationContextChecker
