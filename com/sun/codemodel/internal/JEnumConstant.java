...
/*     */ 
/*     */ public final class JEnumConstant extends JExpressionImpl
...
/* 149 */         f.g((JGenerable)this.annotations.get(i)).nl();
/*     */     }
/* 151 */     f.id(this.name);
/* 152 */     if (this.args != null)
/* 153 */       f.p('(').g(this.args).p(')');
/*     */   }
/*     */ 
 ...
 * Qualified Name:     com.sun.codemodel.internal.JEnumConstant
