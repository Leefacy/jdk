...
/*     */   }
/*     */ 
/*  64 */   public Iterator<MessagePart> parts() { return this._parts.iterator(); }
/*     */ 
...
/*  72 */     return (MessagePart)this._partsByName.get(name);
/*     */   }
/*     */ 
/*     */   public int numParts() {
...
/*     */ 
/*  98 */     for (Iterator iter = this._parts.iterator(); iter.hasNext(); )
...
/* 105 */     for (Iterator iter = this._parts.iterator(); iter.hasNext(); ) {
 ...
 * Qualified Name:     com.sun.tools.internal.ws.wsdl.document.Message
