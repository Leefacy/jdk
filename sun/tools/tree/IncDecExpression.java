...
/*  90 */       if ((this.right.op == 60) && (this.type.isType(4)) && 
/*  91 */         (((IdentifierExpression)this.right).field
/*  91 */         .isLocal()))
/*     */       {
/*  93 */         return 3;
/*     */       }
...
/*     */   {
/*     */     int i;
/* 153 */     if ((this.right.op == 60) && (this.type.isType(4)) && 
/* 154 */       (((IdentifierExpression)this.right).field
...
/*     */       }
/* 158 */       i = ((LocalMember)((IdentifierExpression)this.right).field).number;
...
/*     */     {
/* 170 */       i = this.right.codeLValue(paramEnvironment, paramContext, paramAssembler);
 ...
 * Qualified Name:     sun.tools.tree.IncDecExpression
