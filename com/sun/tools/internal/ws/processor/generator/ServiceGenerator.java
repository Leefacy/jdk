...
/*     */   }
/*     */ 
/*     */   public void visit(com.sun.tools.internal.ws.processor.model.Service service)
/*     */   {
/*  88 */     JavaInterface intf = service.getJavaInterface();
/*  89 */     String className = Names.customJavaTypeClassName(intf);
/*  90 */     if ((this.donotOverride) && (GeneratorUtil.classExists(this.options, className))) {
...
/* 113 */       JExpr._new(this.cm
/* 113 */       .ref(QName.class))
/* 113 */       .arg(service.getName().getNamespaceURI()).arg(service.getName().getLocalPart()));
/*     */ 
...
/*     */         {
/*     */           JType retType;
/* 218 */           QName portTypeName = (QName)port
/* 218 */             .getProperty("com.sun.xml.internal.ws.processor.model.WSDLPortTypeName");
/*     */ 
...
/*     */       }
/*     */     }
/* 240 */     writeGetWsdlLocation(this.cm.ref(URL.class), cls, urlField, exField);
/*     */   }
/*     */ 
...
/* 284 */     JVar urlVar = staticBlock.decl(this.cm.ref(URL.class), "url", JExpr._null());
/* 285 */     JVar exVar = staticBlock.decl(this.cm.ref(WebServiceException.class), "e", JExpr._null());
/*     */ 
/* 287 */     JTryBlock tryBlock = staticBlock._try();
/* 288 */     tryBlock.body().assign(urlVar, JExpr._new(this.cm.ref(URL.class)).arg(this.wsdlLocation));
/* 289 */     JCatchBlock catchBlock = tryBlock._catch(this.cm.ref(MalformedURLException.class));
/* 290 */     catchBlock.param("ex");
/* 291 */     catchBlock.body().assign(exVar, JExpr._new(this.cm.ref(WebServiceException.class)).arg(JExpr.ref("ex")));
/*     */ 
...
/* 312 */     staticBlock.assign(urlField, JExpr.dotclass(this.cm.ref(className)).invoke("getResource").arg(this.wsdlLocation));
/* 313 */     JVar exVar = staticBlock.decl(this.cm.ref(WebServiceException.class), "e", JExpr._null());
/* 314 */     JConditional ifBlock = staticBlock._if(urlField.eq(JExpr._null()));
/* 315 */     ifBlock._then().assign(exVar, JExpr._new(this.cm.ref(WebServiceException.class)).arg("Cannot find " + 
/* 316 */       JExpr.quotify('\'', this.wsdlLocation) + 
/* 316 */       " wsdl. Place the resource correctly in the classpath."));
...
/* 335 */     staticBlock.assign(urlField, JExpr.dotclass(this.cm.ref(className)).invoke("getClassLoader").invoke("getResource").arg(this.wsdlLocation));
/* 336 */     JVar exVar = staticBlock.decl(this.cm.ref(WebServiceException.class), "e", JExpr._null());
/* 337 */     JConditional ifBlock = staticBlock._if(urlField.eq(JExpr._null()));
/* 338 */     ifBlock._then().assign(exVar, JExpr._new(this.cm.ref(WebServiceException.class)).arg("Cannot find " + 
/* 339 */       JExpr.quotify('\'', this.wsdlLocation) + 
/* 339 */       " wsdl. Place the resource correctly in the classpath."));
...
/* 361 */     JVar exVar = staticBlock.decl(this.cm.ref(WebServiceException.class), "e", JExpr._null());
/* 362 */     JVar urlVar = staticBlock.decl(this.cm.ref(URL.class), "url", JExpr._null());
/* 363 */     JTryBlock tryBlock = staticBlock._try();
/* 364 */     tryBlock.body().assign(urlVar, JExpr._new(this.cm.ref(URL.class)).arg(JExpr.dotclass(this.cm.ref(className)).invoke("getResource").arg(".")).arg(this.wsdlLocation));
/* 365 */     JCatchBlock catchBlock = tryBlock._catch(this.cm.ref(MalformedURLException.class));
/* 366 */     JVar murlVar = catchBlock.param("murl");
/* 367 */     catchBlock.body().assign(exVar, JExpr._new(this.cm.ref(WebServiceException.class)).arg(murlVar));
...
/*     */   }
/*     */ 
/*     */   private void writeWebServiceClientAnnotation(com.sun.tools.internal.ws.processor.model.Service service, JAnnotationUse wsa) {
 ...
 * Qualified Name:     com.sun.tools.internal.ws.processor.generator.ServiceGenerator
