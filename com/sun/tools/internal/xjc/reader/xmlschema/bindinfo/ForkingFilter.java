...
/*     */   {
/* 111 */     if ("http://www.w3.org/XML/1998/namespace".equals(uri)) return;
/* 112 */     if (this.side != null)
...
/*     */   {
/* 121 */     if ("xml".equals(prefix)) return;
/* 122 */     if (this.side != null)
...
/* 149 */       side.startPrefixMapping((String)this.namespaces.get(i), (String)this.namespaces.get(i + 1));
...
/* 160 */           this.side.endPrefixMapping((String)this.namespaces.get(i));
 ...
 * Qualified Name:     com.sun.tools.internal.xjc.reader.xmlschema.bindinfo.ForkingFilter
