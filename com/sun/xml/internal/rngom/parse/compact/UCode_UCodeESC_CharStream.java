...
/*     */   private static final char NEWLINE_MARKER = '\000';
/*     */   private static final char BOM = 'Ôªø';
/*     */ 
...
/* 199 */     if (this.inBuf > 0) {
/* 200 */       this.inBuf -= 1;
/* 201 */       return this.buffer[(this.tokenBegin = ++this.bufpos)];
/*     */     }
/*     */ 
...
/*     */       default:
/* 278 */         if (c >= ' ') {
/* 279 */           if (!Utf16.isSurrogate(c)) break label291;
...
/*     */           }
/* 293 */           if (Utf16.isSurrogate2(c)) break label291;
...
/* 346 */         if (this.bufpos >= 0) break;
/* 347 */         this.bufpos += this.bufsize; break;
/*     */       }
/*     */ 
/* 351 */       if (c != 'x') {
/* 352 */         backup(xCnt);
...
/* 382 */           break;
/*     */         default:
/* 384 */           if ((c >= ' ') && (!Utf16.isSurrogate(c)))
/*     */           {
/*     */             break;
/*     */           }
/*     */         case 'Ôøæ':
/*     */         case 'èøø':
/* 390 */           throw new EscapeSyntaxException("illegal_char_code_ref", this.line, this.column);
/*     */         }
...
/* 404 */       backup(1);
/* 405 */       return c; } catch (EOFException e) {
/*     */     }
 ...
 * Qualified Name:     com.sun.xml.internal.rngom.parse.compact.UCode_UCodeESC_CharStream
