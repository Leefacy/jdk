...
/*     */       }
/*  85 */       else if ((e instanceof GWildcardElement)) {
/*  86 */         GWildcardElement w = (GWildcardElement)e;
/*  87 */         rtsb.getRefs().add(new RawTypeSetBuilder.WildcardRef(w
/*  88 */           .isStrict() ? WildcardMode.STRICT : WildcardMode.SKIP));
/*     */       }
/*  91 */       else if (!$assertionsDisabled) { throw new AssertionError(e); }
/*     */ 
/*     */     }
 ...
 * Qualified Name:     com.sun.tools.internal.xjc.reader.xmlschema.ExpressionParticleBinder
