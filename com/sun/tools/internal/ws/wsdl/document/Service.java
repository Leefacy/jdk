...
/*  78 */     for (Iterator iter = this._ports.iterator(); iter.hasNext(); ) {
...
/*  86 */     for (Iterator iter = this._ports.iterator(); iter.hasNext(); ) {
 ...
 * Qualified Name:     com.sun.tools.internal.ws.wsdl.document.Service
