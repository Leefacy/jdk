...
/* 108 */             File file = (File)SchemaGenerator.this.schemaLocations.get(namespaceUri);
...
/*     */ 
/* 115 */             out = SchemaGenerator.this.processingEnv.getFiler().createResource(StandardLocation.CLASS_OUTPUT, "", suggestedFileName, new Element[0])
 ...
 * Qualified Name:     com.sun.tools.internal.jxc.ap.SchemaGenerator
