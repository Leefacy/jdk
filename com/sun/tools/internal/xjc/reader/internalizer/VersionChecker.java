...
/*     */         {
/* 101 */           SAXParseException e = new SAXParseException(
/* 101 */             Messages.format("Internalizer.TwoVersionAttributes", new Object[0]), 
/* 101 */             this.locator);
...
/*     */     {
/* 120 */       SAXParseException e = new SAXParseException(
/* 120 */         Messages.format("Internalizer.VersionNotPresent", new Object[0]), 
/* 120 */         this.rootTagStart);
/* 121 */       getErrorHandler().error(e);
/*     */     }
/*     */ 
/* 125 */     if ((this.version != null) && (!VERSIONS.contains(this.version)))
/*     */     {
/* 127 */       SAXParseException e = new SAXParseException(
/* 127 */         Messages.format("Internalizer.IncorrectVersion", new Object[0]), 
/* 127 */         this.rootTagStart);
 ...
 * Qualified Name:     com.sun.tools.internal.xjc.reader.internalizer.VersionChecker
