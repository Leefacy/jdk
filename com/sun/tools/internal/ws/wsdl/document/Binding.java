...
/*  96 */     for (Iterator iter = this._operations.iterator(); iter.hasNext(); ) {
...
/* 121 */     for (Iterator iter = this._operations.iterator(); iter.hasNext(); ) {
 ...
 * Qualified Name:     com.sun.tools.internal.ws.wsdl.document.Binding
